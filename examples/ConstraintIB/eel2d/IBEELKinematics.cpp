...
void
IBEELKinematics::setImmersedBodyLayout(Pointer<SAMRAIPatchHierarchy> patch_hierarchy)
{
    ...
    Pointer<SAMRAIPatchLevel> level = patch_hierarchy->getPatchLevel(finest_ln);
