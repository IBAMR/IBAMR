...
struct SolidLevelSetResetter
{
    SolidLevelSetResetter(SAMRAIPointer<AdvDiffHierarchyIntegrator> integrator,
                          SAMRAIPointer<SAMRAICellVariable<double>> var,
...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<SAMRAICellVariable<double>> phi_var_foilA = new SAMRAICellVariable<double>(ls_foilA);
        const string& ls_foilB = "level_set_foilB";
        SAMRAIPointer<SAMRAICellVariable<double>> phi_var_foilB = new SAMRAICellVariable<double>(ls_foilB);
        ...
        SAMRAIPointer<CartGridFunction> phi_foilB_init = new LevelSetInitialCondition("phi_foilB_init", foilB);
        ...
        SAMRAIPointer<BrinkmanPenalizationRigidBodyDynamics> bp_rbd_B =
