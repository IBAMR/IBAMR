...
struct SolidLevelSetResetter
{
    SolidLevelSetResetter(Pointer<AdvDiffHierarchyIntegrator> integrator,
                          Pointer<SAMRAICellVariable<double>> var,
...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        Pointer<SAMRAICellVariable<double>> phi_var_foilA = new SAMRAICellVariable<double>(ls_foilA);
        const string& ls_foilB = "level_set_foilB";
        Pointer<SAMRAICellVariable<double>> phi_var_foilB = new SAMRAICellVariable<double>(ls_foilB);
