...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<CartGridFunction> phi_init_gas =
            make_samrai_shared<LevelSetGasInitialCondition>("ls_init_gas", greater_x_column, less_z_column);
        adv_diff_integrator->setInitialConditions(phi_var_gas, phi_init_gas);

        SAMRAIPointer<CartGridFunction> phi_init_solid =
            make_samrai_shared<LevelSetSolidInitialCondition>("ls_init_solid", rectangle);
