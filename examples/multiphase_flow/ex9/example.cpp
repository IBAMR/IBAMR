...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        adv_diff_integrator->registerResetFunction(
            phi_var_solid, &LevelSetUtilities::setLSDataPatchHierarchy, static_cast<void*>(&setSetLSPropertiesSolid));

        IBAMR::LevelSetUtilities::SetLSProperties setSetLSPropertiesGas("SetLSPropertiesGas", level_set_gas_ops);
        adv_diff_integrator->registerResetFunction(
            phi_var_gas, &LevelSetUtilities::setLSDataPatchHierarchy, static_cast<void*>(&setSetLSPropertiesGas));
