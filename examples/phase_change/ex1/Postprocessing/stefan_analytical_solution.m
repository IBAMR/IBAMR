...
%  The value 2.0 is fzero's starting guess for lambda, not a physical initial
%  condition. Check the residual and select the positive root on the branch
%  continuous with neighboring times. If another root is found, change the
%  starting guess or bracket while keeping the physical input data fixed.
