...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        ac_hier_integrator->registerResetDiffusionCoefficientFcn(&callSetLiquidGasConductivityCallbackFunction,
                                                                 static_cast<void*>(ptr_SetFluidProperties));

        ac_hier_integrator->registerResetSpecificHeatFcn(&callSetLiquidGasSpecificHeatCallbackFunction,
                                                         static_cast<void*>(ptr_SetFluidProperties));

        ac_hier_integrator->registerResetDensityFcn(&callSetLiquidGasDensityCallbackFunction,
                                                    static_cast<void*>(ptr_SetFluidProperties));
