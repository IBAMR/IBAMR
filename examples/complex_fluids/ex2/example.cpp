                 ...
                 const string& data_dump_dirname)
{
    ...
    if (polymericStressForcing)
    {
        ...
        SAMRAIPointer<SAMRAIPatchLevel> level = patch_hierarchy->getPatchLevel(patch_hierarchy->getFinestLevelNumber());
        SAMRAIPointer<SAMRAIPatch> patch = level->getPatch(SAMRAIPatchLevel::Iterator(level)());
