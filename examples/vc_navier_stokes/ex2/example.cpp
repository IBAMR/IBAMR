...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        std::vector<SAMRAIRobinBcCoefStrategy*> u_bc_coefs(NDIM);
        ...
        SAMRAIPointer<CartGridFunction> grav_force = new GravityForcing("GravityForcing", time_integrator, grav_const);
