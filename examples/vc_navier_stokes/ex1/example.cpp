...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        Pointer<SAMRAISideVariable<double>> rho_var = new SAMRAISideVariable<double>("rho_var");
        Pointer<SAMRAICellVariable<double>> mu_var = new SAMRAICellVariable<double>("mu_var");
        ...
        const Pointer<SAMRAIVariable> r_var = time_integrator->getMassDensityVariable();
        ...
        Pointer<SAMRAISideVariable<double>> r_sc_var = r_var;
        if (r_sc_var)
        {
            SAMRAIHierarchySideDataOpsReal<double> hier_sc_data_ops(patch_hierarchy, coarsest_ln, finest_ln);
