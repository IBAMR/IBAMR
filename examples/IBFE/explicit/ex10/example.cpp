...
void postprocess_data(double loop_time, SAMRAIPointer<IBFEDirectForcingKinematics> df_kinematics_ops);
...
void
postprocess_data(double loop_time, SAMRAIPointer<IBFEDirectForcingKinematics> df_kinematics_ops)
{
