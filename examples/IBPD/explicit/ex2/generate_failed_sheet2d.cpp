...
main(int /*argc*/, char** /*argv*/)
{
    ...
    std::vector<int> target_lower(n_x_crack);
    std::vector<int> target_upper(n_x_crack);
    std::vector<int> target_right(n_y);
    std::vector<int> target_left(n_y);
