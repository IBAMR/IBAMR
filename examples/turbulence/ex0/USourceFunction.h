...
#ifndef included_USourceFunction
#define included_USourceFunction
 ...
 */
class USourceFunction : public CartGridFunction
{
public:
    /*!
     * \brief Constructor.
...
private:
     ...
     */
    USourceFunction(const USourceFunction& from);
     ...
     */
    USourceFunction& operator=(const USourceFunction& that);
