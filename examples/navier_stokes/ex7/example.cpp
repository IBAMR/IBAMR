...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        Pointer<CartGridFunction> p_exact = new muParserCartGridFunction(
            "p_exact", app_initializer->getComponentDatabase("PressureExactSolution"), grid_geometry);
        ...
        Pointer<INSStaggeredHierarchyIntegrator> ins_hier_integrator = time_integrator;
        ins_hier_integrator->registerContinuitySourceFcn(&evaluate_div_u_F_callback_fcn, nullptr);
        ...
        p_exact->setDataOnPatchHierarchy(p_cloned_idx, p_var, patch_hierarchy, loop_time - 0.5 * dt);
