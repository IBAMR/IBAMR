...
evaluate_velocity(const ManufacturedCase manufactured_case, const Vector& X)
{
    ...
    default:
        TBOX_ERROR("Unsupported manufactured SGS case enum value " << static_cast<int>(manufactured_case) << "\n");
    }
    return U;
}
...
main(int argc, char* argv[])
{
    ...
    Pointer<AppInitializer> app_initializer = new AppInitializer(argc, argv, "sgs_verification.log");
