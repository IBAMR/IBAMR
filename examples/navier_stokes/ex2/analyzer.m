...
u512 = reshape(load('u.N=512'),513,512);
...
uI256 = 0.5*u512(1:2:size(u512,1),1:2:size(u512,2)) + 0.5*u512(1:2:size(u512,1),2:2:size(u512,2));

u1_32_64 = L1normx(u32-uI32);
u1_64_128 = L1normx(u64-uI64);
u1_128_256 = L1normx(u128-uI128);
u1_256_512 = L1normx(u256-uI256);
...
fprintf('|u128-u256|_1  = %1.2e  rate = %2.2f\n',u1_128_256,log2(u1_128_256/u1_256_512));
fprintf('|u256-u512|_1  = %1.2e  rate = ---\n\n',u1_256_512);

u2_32_64 = L2normx(u32-uI32);
u2_64_128 = L2normx(u64-uI64);
u2_128_256 = L2normx(u128-uI128);
u2_256_512 = L2normx(u256-uI256);
...
fprintf('|u128-u256|_2  = %1.2e  rate = %2.2f\n',u2_128_256,log2(u2_128_256/u2_256_512));
fprintf('|u256-u512|_2  = %1.2e  rate = ---\n\n',u2_256_512);

uoo_32_64 = max(max(abs(u32-uI32)));
uoo_64_128 = max(max(abs(u64-uI64)));
uoo_128_256 = max(max(abs(u128-uI128)));
uoo_256_512 = max(max(abs(u256-uI256)));
...
fprintf('|u128-u256|_oo = %1.2e  rate = %2.2f\n',uoo_128_256,log2(uoo_128_256/uoo_256_512));
fprintf('|u256-u512|_oo = %1.2e  rate = ---\n\n',uoo_256_512);
...
v512 = reshape(load('v.N=512'),512,513);
...
vI256 = 0.5*v512(1:2:size(v512,1),1:2:size(v512,2)) + 0.5*v512(2:2:size(v512,1),1:2:size(v512,2));

v1_32_64 = L1normy(v32-vI32);
v1_64_128 = L1normy(v64-vI64);
v1_128_256 = L1normy(v128-vI128);
v1_256_512 = L1normy(v256-vI256);
...
fprintf('|v128-v256|_1  = %1.2e  rate = %2.2f\n',v1_128_256,log2(v1_128_256/v1_256_512));
fprintf('|v256-v512|_1  = %1.2e  rate = ---\n\n',v1_256_512);

v2_32_64 = L2normy(v32-vI32);
v2_64_128 = L2normy(v64-vI64);
v2_128_256 = L2normy(v128-vI128);
v2_256_512 = L2normy(v256-vI256);
...
fprintf('|v128-v256|_2  = %1.2e  rate = %2.2f\n',v2_128_256,log2(v2_128_256/v2_256_512));
fprintf('|v256-v512|_2  = %1.2e  rate = ---\n\n',v2_256_512);

voo_32_64 = max(max(abs(v32-vI32)));
voo_64_128 = max(max(abs(v64-vI64)));
voo_128_256 = max(max(abs(v128-vI128)));
voo_256_512 = max(max(abs(v256-vI256)));
...
fprintf('|v128-v256|_oo = %1.2e  rate = %2.2f\n',voo_128_256,log2(voo_128_256/voo_256_512));
fprintf('|v256-v512|_oo = %1.2e  rate = ---\n\n',voo_256_512);
...
p512 = reshape(load('p.N=512'),512,512);
...
pI256 = 0.25*p512(1:2:size(p512,1),1:2:size(p512,1)) + 0.25*p512(2:2:size(p512,1),1:2:size(p512,1)) + 0.25*p512(1:2:size(p512,1),2:2:size(p512,1)) + 0.25*p512(2:2:size(p512,1),2:2:size(p512,1));

p1_32_64 = L1norm(p32-pI32);
p1_64_128 = L1norm(p64-pI64);
p1_128_256 = L1norm(p128-pI128);
p1_256_512 = L1norm(p256-pI256);
...
fprintf('|p128-p256|_1  = %1.2e  rate = %2.2f\n',p1_128_256,log2(p1_128_256/p1_256_512));
fprintf('|p256-p512|_1  = %1.2e  rate = ---\n\n',p1_256_512);

p2_32_64 = L2norm(p32-pI32);
p2_64_128 = L2norm(p64-pI64);
p2_128_256 = L2norm(p128-pI128);
p2_256_512 = L2norm(p256-pI256);
...
fprintf('|p128-p256|_2  = %1.2e  rate = %2.2f\n',p2_128_256,log2(p2_128_256/p2_256_512));
fprintf('|p256-p512|_2  = %1.2e  rate = ---\n\n',p2_256_512);

poo_32_64 = max(max(abs(p32-pI32)));
poo_64_128 = max(max(abs(p64-pI64)));
poo_128_256 = max(max(abs(p128-pI128)));
poo_256_512 = max(max(abs(p256-pI256)));
...
fprintf('|p128-p256|_oo = %1.2e  rate = %2.2f\n',poo_128_256,log2(poo_128_256/poo_256_512));
fprintf('|p256-p512|_oo = %1.2e  rate = ---\n\n',poo_256_512);
