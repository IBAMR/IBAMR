...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<CartGridFunction> phi_solid_init = make_samrai_shared<LevelSetInitialCondition>(
            "ls_init", grid_geometry, radius, origin, fluid_is_interior_to_cylinder);
