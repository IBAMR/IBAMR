...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        Pointer<SAMRAICellVariable<double>> phi_outer_solid_var =
            new SAMRAICellVariable<double>("level_set_outer_solid");
        ...
        std::vector<Pointer<SAMRAICellVariable<double>>> ls_vars;
        ls_vars.push_back(phi_outer_solid_var);

        const string& ls_name = "level_set_inner_solid";
        Pointer<SAMRAICellVariable<double>> phi_inner_solid_var = new SAMRAICellVariable<double>(ls_name);
