...
void postprocess_Convergence(SAMRAIPointer<SAMRAIPatchHierarchy> patch_hierarchy,
...
void
postprocess_Convergence(SAMRAIPointer<SAMRAIPatchHierarchy> /*patch_hierarchy*/,
                        SAMRAIPointer<INSHierarchyIntegrator> /*navier_stokes_integrator*/,
                        Mesh& mesh,
                        EquationSystems* equation_systems,
                        const int /*iteration_num*/,
