...
struct TetherData
{
    ...
    TetherData(SAMRAIPointer<SAMRAIDatabase> input_db)
...
void postprocess_data(SAMRAIPointer<SAMRAIDatabase> input_db,
...
void
postprocess_data(SAMRAIPointer<SAMRAIDatabase> input_db,
                 SAMRAIPointer<SAMRAIPatchHierarchy> /*patch_hierarchy*/,
                 SAMRAIPointer<INSHierarchyIntegrator> /*navier_stokes_integrator*/,
                 Mesh& mesh,
                 EquationSystems* equation_systems,
