...
VelocityBcCoefs::VelocityBcCoefs(const INSHierarchyIntegrator* fluid_solver,
...
//                const Point& posn2 = Point(0.0,h2_in,z_min);
                ...
                const double u_in = parabolic_flow(fill_time,X[1],X[1] > 0 ? r1/r_in : r2/r_in); //d_circ_model->d_psrc[side]; //pressure source
