...
void postprocess_CL_CD(SAMRAIPointer<PatchHierarchyNd> patch_hierarchy,
...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<Database> airfoil_params_db = app_initializer->getComponentDatabase("AirfoilParams");
        ...
        std::unique_ptr<ExodusII_IO> exodus_bndry_io(uses_exodus ? new ExodusII_IO(bndry_mesh) : nullptr);
...
void
postprocess_CL_CD(SAMRAIPointer<PatchHierarchyNd> /*patch_hierarchy*/,
                  SAMRAIPointer<INSHierarchyIntegrator> /*navier_stokes_integrator*/,
                  Mesh& mesh,
                  EquationSystems* equation_systems,
                  const int /*iteration_num*/,
