...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        Pointer<SAMRAICellVariable<double>> r_cc_var = new SAMRAICellVariable<double>("r_cc");
        ...
        f_vec.addScalar(Pointer<SAMRAISAMRAIVectorReal<double>>(&f_vec, false),
                        -f_vec.dot(Pointer<SAMRAISAMRAIVectorReal<double>>(&r_vec, false)) /
