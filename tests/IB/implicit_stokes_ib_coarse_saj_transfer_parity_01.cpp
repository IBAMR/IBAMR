...
/*
 * This test checks coarse-level classical Vanka and SAJ transfer parity for a
 * simple multilevel implicit Stokes-IB configuration.
 */
...
main(int argc, char* argv[])
{
    ...
    ib_method_ops->constructInterpOp(J,
                                     IBTK::PETScMatUtilities::ib_4_delta_fcn,
                                     IBTK::PETScMatUtilities::ib_4_delta_stencil,
                                     full_num_dofs_fine,
    ...
    if (!IBTK::abs_equal_eps(inf_norm, 0.0, parity_tol)) ++test_failures;
