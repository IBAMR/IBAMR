...
main(int argc, char* argv[])
{
    ...
    std::vector<std::vector<int>> overlap_geom, nonoverlap_geom;
    ...
    std::vector<std::vector<int>> overlap_cav, nonoverlap_cav;
    ...
    std::vector<std::vector<int>> overlap_cav_stride2, nonoverlap_cav_stride2;
    IBAMR::StaggeredStokesPETScMatUtilities::constructPatchLevelCouplingAwareASMSubdomains(
        overlap_cav_stride2,
