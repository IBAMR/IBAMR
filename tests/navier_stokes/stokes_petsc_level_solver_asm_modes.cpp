...
main(int argc, char* argv[])
{
    ...
    out << "asm_subdomain_construction_mode = " << asm_mode << "\n";
    out << "coupling_aware_asm_closure_policy = " << closure_policy << "\n";
    out << "subdomain_box_size = " << box_size << "\n";
    out << "subdomain_overlap_size = " << overlap_size << "\n";
    out << "coupling_aware_asm_seed_axis = " << seed_axis << "\n";
    out << "coupling_aware_asm_seed_stride = " << seed_stride << "\n";
    out << "n_local_dofs = " << n_local_dofs << "\n";
    out << "n_subdomains = " << stats.n_subdomains << "\n";
    out << "overlap_sizes = " << stats.overlap_min << " " << stats.overlap_max << " " << stats.overlap_avg << "\n";
    out << "nonoverlap_sizes = " << stats.nonoverlap_min << " " << stats.nonoverlap_max << " " << stats.nonoverlap_avg
        << "\n";
    out << "overlap_hash = " << stats.overlap_hash << "\n";
    out << "nonoverlap_hash = " << stats.nonoverlap_hash << "\n";
    out << "compare_against_mode = " << (run_comparison ? 1 : 0) << "\n";
    if (run_comparison)
    {
        out << "compare_asm_subdomain_construction_mode = " << compare_asm_mode << "\n";
        out << "compare_coupling_aware_asm_closure_policy = " << compare_closure_policy << "\n";
        out << "compare_subdomain_box_size = " << compare_box_size << "\n";
        out << "compare_subdomain_overlap_size = " << compare_overlap_size << "\n";
        out << "compare_coupling_aware_asm_seed_axis = " << compare_seed_axis << "\n";
        out << "compare_coupling_aware_asm_seed_stride = " << compare_seed_stride << "\n";
        out << "compare_n_subdomains = " << compare_stats.n_subdomains << "\n";
        out << "compare_overlap_sizes = " << compare_stats.overlap_min << " " << compare_stats.overlap_max << " "
            << compare_stats.overlap_avg << "\n";
        out << "compare_nonoverlap_sizes = " << compare_stats.nonoverlap_min << " " << compare_stats.nonoverlap_max
            << " " << compare_stats.nonoverlap_avg << "\n";
        out << "compare_overlap_hash = " << compare_stats.overlap_hash << "\n";
        out << "compare_nonoverlap_hash = " << compare_stats.nonoverlap_hash << "\n";
        out << "compare_overlap_equal = " << (compare_overlap_equal ? 1 : 0) << "\n";
        out << "compare_nonoverlap_equal = " << (compare_nonoverlap_equal ? 1 : 0) << "\n";
    }
