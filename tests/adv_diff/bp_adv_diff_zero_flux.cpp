...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<CartGridFunction> phi_left_solid_init =
            make_samrai_shared<LevelSetInitialCondition1D>("ls_left_solid_init", grid_geometry, interface_left, true);
        ...
        SAMRAIPointer<CartGridFunction> phi_right_solid_init =
            make_samrai_shared<LevelSetInitialCondition1D>("ls_right_solid_init", grid_geometry, interface_right);
