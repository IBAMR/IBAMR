...
main(int argc, char** argv)
{
...

    {
        ...
        const int p_current_idx = var_db->mapVariableAndContextToIndex(p_var, p_current_ctx);
        const int u_current_idx = var_db->mapVariableAndContextToIndex(u_var, u_current_ctx);
        SAMRAIPointer<SAMRAISideVariable<double>> u_copy_var = new SAMRAISideVariable<double>("u_copy");
        SAMRAIPointer<SAMRAICellVariable<double>> p_copy_var = new SAMRAICellVariable<double>("p_copy");
