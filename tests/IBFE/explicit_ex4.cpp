    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<IBFEMethod> ib_method_ops =
            new IBFEMethod("IBFEMethod",
                           ...
                           restart_restore_num);
        SAMRAIPointer<IBExplicitHierarchyIntegrator> time_integrator =
        ...
        {
            SAMRAIPointer<SAMRAIPatchHierarchy> scratch_hier = ib_method_ops->getScratchHierarchy();
            TBOX_ASSERT(scratch_hier);
            SAMRAIPointer<SAMRAIPatchLevel> patch_level =
                scratch_hier->getPatchLevel(scratch_hier->getFinestLevelNumber());
