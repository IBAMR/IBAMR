...
main(int argc, char* argv[])
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<IBFESurfaceMethod> ibfe_surface =
        ...
        std::vector<SAMRAIPointer<IBStrategy>> ibfes{ ibfe_surface, ibfe };
        SAMRAIPointer<IBStrategySet> ib_ops = new IBStrategySet(ibfes.begin(), ibfes.end());
