...
/*
 * Test based on IBFE/explicit/ex0. This test involves computations with edge
 * elements.
 */
...
main(int argc, char** argv)
{
    ...
    { // cleanup dynamically allocated objects prior to shutdown
        ...
        SAMRAIPointer<IBFEPostProcessor> ib_post_processor =
            make_samrai_shared<IBFECentroidPostProcessor>("IBFEPostProcessor", fe_data_manager);
        {
        ...
        const SAMRAIPointer<hier::VariableNd> u_var = navier_stokes_integrator->getVelocityVariable();
        ...
        const SAMRAIPointer<hier::VariableNd> p_var = navier_stokes_integrator->getPressureVariable();
