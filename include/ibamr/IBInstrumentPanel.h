...
private:
    ...
    using WebPatchMap = std::multimap<SAMRAI::hier::IndexNd, WebPatch, IndexFortranOrder>;
    ...
    using WebCentroidMap = std::multimap<SAMRAI::hier::IndexNd, WebCentroid, IndexFortranOrder>;
