...
{
/*!
 * \brief Class INSVCStaggeredConservativeMassMomentumSSPRKIntegrator integrates
 ...
 */
class INSVCStaggeredConservativeMassMomentumSSPRKIntegrator : public virtual SAMRAI::tbox::DescribedClass
{
public:
    /*!
     ...
     * \brief Destructor.
     */
    virtual ~INSVCStaggeredConservativeMassMomentumSSPRKIntegrator();
