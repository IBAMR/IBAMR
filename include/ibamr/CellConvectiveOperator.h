...
public:
     ...
     */
    virtual void interpolateToFaceOnPatch(SAMRAIFaceData<double>& q_interp_data,
                                          const SAMRAICellData<double>& Q_cell_data,
                                          const SAMRAIFaceData<double>& u_data,
                                          const SAMRAIPatch& patch) = 0;
     ...
     */
    virtual void evaluateAdvectiveFluxOnPatch(SAMRAIFaceData<double>& q_flux_data,
                                              const SAMRAICellData<double>& Q_cell_data,
                                              const SAMRAIFaceData<double>& u_data,
