...
#ifndef included_IBAMR_INSStaggeredGDHierarchyIntegrator
#define included_IBAMR_INSStaggeredGDHierarchyIntegrator
...
{
/*!
 * \brief Class INSStaggeredGDHierarchyIntegrator provides a staggered-grid solver
 * for the incompressible Navier-Stokes equations on an AMR grid hierarchy.
 */
class INSStaggeredGDHierarchyIntegrator : public INSHierarchyIntegrator
{
public:
    /*!
     * The constructor for class INSStaggeredGDHierarchyIntegrator sets some
     * default values, reads in configuration information from input and restart
     * databases, and registers the integrator object with the restart manager
     * when requested.
     */
    INSStaggeredGDHierarchyIntegrator(std::string object_name,
                                    SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> input_db,
                                    bool register_for_restart = true);

    /*!
     * The destructor for class INSStaggeredGDHierarchyIntegrator unregisters the
...
private:
     ...
     */
    INSStaggeredGDHierarchyIntegrator() = delete;
     ...
     */
    INSStaggeredGDHierarchyIntegrator(const INSStaggeredGDHierarchyIntegrator& from) = delete;
     ...
     */
    INSStaggeredGDHierarchyIntegrator& operator=(const INSStaggeredGDHierarchyIntegrator& that) = delete;
...
#endif // #ifndef included_IBAMR_INSStaggeredGDHierarchyIntegrator
