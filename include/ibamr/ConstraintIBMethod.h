...
// This is a concrete class which implements fast and efficient distributed 
// Lagrange multiplier (fictitious domain) method for immersed structures. 
...
private:
     ...
     */
    bool d_print_output, d_output_drag, d_output_torque, d_output_power,d_output_trans_vel,
    ...
    std::vector<SAMRAI::tbox::Pointer<IBTK::LData> > d_l_data_U_interp, d_l_data_U_correction,
        d_l_data_U_new, d_l_data_U_current, d_l_data_U_half, d_l_data_X_half_Euler, d_l_data_X_new_MidPoint;
