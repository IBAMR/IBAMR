...
public:
    ...
    virtual void postprocessData(int u_idx,
                                 int p_idx,
                                 int f_idx,
                                 const std::vector<IBTK::SAMRAIPointer<IBTK::LData> >& F_data,
                                 const std::vector<IBTK::SAMRAIPointer<IBTK::LData> >& X_data,
                                 const std::vector<IBTK::SAMRAIPointer<IBTK::LData> >& U_data,
