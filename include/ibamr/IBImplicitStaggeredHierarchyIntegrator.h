 ...
 * IBTK::dispatch_ib_kernel_evaluator() supports it (see IBTK::IBOperatorBuilder),
 * which is fewer kernels than the IBTK::IBKernel and LEInteractor catalogs;
 * setJacobianOperatorBuilder() selects any other kernel. The velocity DOF index
