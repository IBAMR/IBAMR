...
public:
     ...
     */
    void registerSpecificHeatVariable(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > specific_heat_var,
                                      const bool output_Cp = false);

    /*!
     * Register the density \f$ \rho \f$ variable.
     */
    void registerDensityVariable(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > rho_var,
     ...
     */
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > getLiquidFractionVariable() const;

    /*!
     * \brief Register liquid fraction variable \f$ \varphi \f$.
     */
    virtual void registerLiquidFractionVariable(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > lf_var,
     ...
     */
    virtual void
    registerLiquidFractionGradientVariable(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > lf_gradient_var,
                                           const bool output_lf_gradient_var = true);

    /*!
     * \brief Register Heaviside variable \f$ H \f$ maintained by AdvDiffHierarchyIntegrator.
     */
    void registerHeavisideVariable(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > H_var);

    /*!
     * \brief Register temperature variable \f$ T \f$.
     */
    void registerTemperatureVariable(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > T_var,
                                     const bool output_T_var = true);

    /*!
     * \brief Set a grid function to provide initial conditions for \f$ \varphi \f$ variable.
     */
    void setLiquidFractionInitialCondition(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > lf_var,
                                           IBTK::SAMRAIPointer<IBTK::CartGridFunction> lf_init);
    /*!
     * \brief Set a grid function to provide initial conditions for  \f$ T \f$ variable.
     */
    void setTemperatureInitialCondition(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > T_var,
                                        IBTK::SAMRAIPointer<IBTK::CartGridFunction> T_init);

    /*!
     * \brief Set a grid function to provide initial conditions for \f$ \rho \f$ variable.
     */
    void setDensityInitialCondition(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > rho_var,
                                    IBTK::SAMRAIPointer<IBTK::CartGridFunction> rho_init);

    /*!
     * \brief Set boundary conditions for \f$ T \f$ variable.
     */
    void setTemperaturePhysicalBcCoef(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > T_var,
    ...
    getEnergyEquationHelmholtzSolver(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > var);
    ...
    getEnergyEquationHelmholtzRHSOperator(IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > var);

    /*!
     * \brief Register an IBTK::CartGridFunction object to specify the value of the
     * source term for energy equation.
     */
    void setEnergyEquationSourceTermFunction(IBTK::SAMRAIPointer<IBTK::CartGridFunction> F_fcn);
     ...
     */
    void setAdvectionVelocity(IBTK::SAMRAIPointer<SAMRAI::pdat::FaceVariableNd<double> > u_var);
...
protected:
     ...
     * Solver variables.
     */
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_lf_var, d_lf_gradient_var, d_lf_pre_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_T_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_T_F_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::SideVariableNd<double> > d_T_diffusion_coef_var, d_T_diffusion_coef_rhs_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_T_diffusion_coef_cc_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_T_rhs_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_T_N_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_T_C_var, d_T_temp_rhs_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_specific_heat_var, d_rho_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_C_var, d_rho_vec_cc_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_H_var, d_H_pre_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_D_cc_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_updated_rho_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::CellVariableNd<double> > d_Div_U_F_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::FaceVariableNd<double> > d_u_adv_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::FaceVariableNd<double> > d_U_old_var;

    /*!
     * Objects to set initial condition for \f$ \varphi \f$, \f$ T \f$ and \f$ \rho \f$.
     */
    IBTK::SAMRAIPointer<IBTK::CartGridFunction> d_lf_init, d_T_init, d_rho_init;

    /*!
     * Cartgrid functions to be used to set the energy equation source term.
     */
    IBTK::SAMRAIPointer<IBTK::CartGridFunction> d_T_F_fcn;
    IBTK::SAMRAIPointer<IBTK::CartGridFunction> d_T_F_init;
     ...
     */
    IBTK::SAMRAIPointer<IBTK::HierarchyGhostCellInterpolation> d_H_bdry_bc_fill_op, d_k_bdry_bc_fill_op;
    ...
    IBTK::SAMRAIPointer<SAMRAI::tbox::Database> d_T_convective_op_input_db = d_default_convective_op_input_db;
    IBTK::SAMRAIPointer<ConvectiveOperator> d_T_convective_op = nullptr;
    ...
    IBTK::SAMRAIPointer<SAMRAI::tbox::Database> d_T_solver_db, d_T_precond_db;
    IBTK::SAMRAIPointer<IBTK::LaplaceOperator> d_T_rhs_op;
    IBTK::SAMRAIPointer<IBTK::PoissonSolver> d_T_solver;
    bool d_T_solver_needs_init, d_T_rhs_op_needs_init;
    IBTK::SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > d_T_sol, d_T_rhs;
