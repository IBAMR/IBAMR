...
private:
    ...
    IBTK::SAMRAIPointer<SAMRAI::tbox::Database> d_stokes_solver_db, d_stokes_precond_db, d_stokes_sub_precond_db;
    ...
    IBTK::SAMRAIPointer<SAMRAI::pdat::NodeVariableNd<double> > d_Omega_nc_var;
     ...
     */
    IBTK::SAMRAIPointer<SAMRAI::pdat::NodeVariableNd<double> > d_U_nc_var;
    IBTK::SAMRAIPointer<SAMRAI::pdat::NodeVariableNd<double> > d_P_nc_var;
