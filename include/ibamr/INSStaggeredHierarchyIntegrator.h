...
private:
    ...
    SAMRAIPointer<IBTK::SideDataSynchronization> d_U_rhs_side_synch_op;
    ...
    SAMRAIPointer<SAMRAIDatabase> d_stokes_solver_db, d_stokes_precond_db, d_stokes_sub_precond_db;
