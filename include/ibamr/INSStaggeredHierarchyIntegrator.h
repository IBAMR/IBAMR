...
private:
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::NodeVariableNd<double> > d_Omega_nc_var;
     ...
     */
    SAMRAI::tbox::Pointer<SAMRAI::pdat::NodeVariableNd<double> > d_U_nc_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::NodeVariableNd<double> > d_P_nc_var;
