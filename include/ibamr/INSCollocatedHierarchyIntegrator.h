...
private:
    ...
    SAMRAI::tbox::Pointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > d_Phi_vec;
    SAMRAI::tbox::Pointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > d_Phi_rhs_vec;
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_F_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_Q_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_N_old_var;
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_Div_u_ADV_var;

    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_Grad_P_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_Phi_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_Grad_Phi_cc_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceVariableNd<double> > d_Grad_Phi_fc_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_F_div_var;
