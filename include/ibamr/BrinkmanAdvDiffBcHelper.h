...
public:
     ...
     */
    bool hasBrinkmanBoundaryCondition(SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > Q_var) const
    {
     ...
     * BCs.
     */
    void registerHomogeneousBC(SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > Q_var,
     ...
     */
    void registerInhomogeneousBC(SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > Q_var,
                                 SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > ls_solid_var,
                                 std::string bc_type,
     ...
     *
     */
    void computeDampingCoefficient(int C_idx, SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > Q_var);
     ...
     */
    void computeForcing(int F_idx, SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > Q_var);
...
private:
     ...
     */
    std::map<SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> >, std::vector<BCProperties> > d_Q_bc;

    /*!
     * Patch data required for computing additional forcing for inhomogeneous Neumann and Robin BCs
     */
    SAMRAI::tbox::Pointer<SAMRAI::pdat::SideVariableNd<double> > d_B_var;
    int d_B_scratch_idx = IBTK::invalid_index, d_B_chi_scratch_idx = IBTK::invalid_index;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariableNd<double> > d_div_var;
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::SideVariableNd<double> > d_n_var;
