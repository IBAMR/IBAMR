...
public:
     ...
     */
    STSMassFluxIntegrator(std::string object_name, SAMRAIPointer<SAMRAIDatabase> input_db);
     ...
     */
    virtual void initializeSTSIntegrator(SAMRAIPointer<SAMRAIBasePatchHierarchy> base_hierarchy) = 0;
     ...
     */
    void setDensityBoundaryConditions(const std::vector<SAMRAIRobinBcCoefStrategy*>& rho_sc_bc_coefs);
     ...
     */
    void setHierarchyMathOps(SAMRAIPointer<IBTK::HierarchyMathOps> hier_math_ops);
...
protected:
    ...
    SAMRAIPointer<IBTK::HierarchyGhostCellInterpolation> d_hier_rho_bdry_fill;
    ...
    SAMRAIPointer<SAMRAIVariable> d_rho_var;
    ...
    SAMRAIPointer<SAMRAIVariable> d_S_var;
    ...
    SAMRAIPointer<SAMRAIVariable> d_E_var;
