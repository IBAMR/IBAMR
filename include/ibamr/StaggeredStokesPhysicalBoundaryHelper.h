...
public:
     ...
     * be set where normal velocity boundary conditions, or both.
     */
    void enforceDivergenceFreeConditionAtBoundary(SAMRAIPointer<SAMRAISideData<double> > u_data,
     ...
     */
    static void setupBcCoefObjects(const std::vector<SAMRAIRobinBcCoefStrategy*>& u_bc_coefs,
     ...
     */
    static void resetBcCoefObjects(const std::vector<SAMRAIRobinBcCoefStrategy*>& u_bc_coefs,
                                   SAMRAIRobinBcCoefStrategy* p_bc_coef);
