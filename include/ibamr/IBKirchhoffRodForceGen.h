...
public:
     ...
     */
    IBKirchhoffRodForceGen(IBTK::SAMRAIPointer<SAMRAI::tbox::Database> input_db = nullptr);
     ...
     */
    void computeLagrangianForceAndTorque(IBTK::SAMRAIPointer<IBTK::LData> F_data,
                                         IBTK::SAMRAIPointer<IBTK::LData> N_data,
