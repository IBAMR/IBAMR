...
public:
     ...
     */
    void setCellCenteredDensityBoundaryConditions(SAMRAI::solv::RobinBcCoefStrategyNd*& rho_cc_bc_coefs);

    /*!
     * \brief Set the boundary condition object for the cell-centered material property.
     */
    void setCellCenteredMaterialPropertyBoundaryConditions(SAMRAI::solv::RobinBcCoefStrategyNd*& gamma_cc_bc_coefs);

    /*!
     * \brief Set the boundary condition object for the cell-centered transport quantity.
     */
    void setCellCenteredTransportQuantityBoundaryConditions(SAMRAI::solv::RobinBcCoefStrategyNd*& Q_cc_bc_coefs);
...
private:
     ...
     */
    SAMRAI::solv::RobinBcCoefStrategyNd* d_rho_cc_bc_coefs;
    SAMRAI::solv::RobinBcCoefStrategyNd* d_gamma_cc_bc_coefs;
    SAMRAI::solv::RobinBcCoefStrategyNd* d_Q_cc_bc_coefs;
