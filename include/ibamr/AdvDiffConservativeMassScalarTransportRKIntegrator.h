 ...
 *
 */
class AdvDiffConservativeMassScalarTransportRKIntegrator : public MassIntegrator
{
public:
    /*!
     ...
     * gamma_new_idx are not set, then it will degenerate to gamma_current automatically, for the
     ...
     * cycle) If Q_new_idx are not set, then it will degenerate to Q_current automatically, for the very
...
private:
    ...
    /*!
     * \brief Compute div[rho_lim*gamma_lim*u_adv*Q_lim]
     */
