...
#ifndef included_IBAMR_MassConservationHierarchyIntegrator
#define included_IBAMR_MassConservationHierarchyIntegrator
...
{
/*!
 * \brief Class MassConservationHierarchyIntegrator manages the spatial
 ...
 */
class MassConservationHierarchyIntegrator : public AdvDiffSemiImplicitHierarchyIntegrator
{
public:
    /*!
     ...
     */
    MassConservationHierarchyIntegrator(const std::string& object_name,
     ...
     */
    ~MassConservationHierarchyIntegrator() = default;
     ...
     */
    void
    setAdvectionVelocityLiquidFractionEquation(SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceVariable<NDIM, double> > u_var);
    /*!
    ...
    /*!
     * \brief get RHS of continuity equation
     */
    int getRHSOfContinuityEquation();
...
private:
     ...
     */
    MassConservationHierarchyIntegrator() = delete;
     ...
     */
    MassConservationHierarchyIntegrator(const MassConservationHierarchyIntegrator& from) = delete;
     ...
     */
    MassConservationHierarchyIntegrator& operator=(const MassConservationHierarchyIntegrator& that) = delete;
