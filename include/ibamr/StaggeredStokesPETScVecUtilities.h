...
public:
     ...
     */
    static SAMRAIPointer<SAMRAIRefineSchedule>
    constructDataSynchSchedule(int u_data_idx, int p_data_idx, SAMRAIPointer<SAMRAIPatchLevel> patch_level);
     ...
     */
    static SAMRAIPointer<SAMRAIRefineSchedule>
    constructGhostFillSchedule(int u_data_idx, int p_data_idx, SAMRAIPointer<SAMRAIPatchLevel> patch_level);
