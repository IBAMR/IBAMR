...
public:
     ...
     * \brief Constructor.
     */
    IBLevelSetMethod(IBTK::SAMRAIPointer<IBStrategy> ib_method_ops, IBTK::SAMRAIPointer<IBStrategy> ibfe_method_ops);

    /*!
     * \brief Get IBMethod ops object.
     */
    IBTK::SAMRAIPointer<IBStrategy> getIBMethodOps() const
    {
     ...
     */
    IBTK::SAMRAIPointer<IBStrategy> getIBFEMethodOps() const
    {
...
private:
     ...
     */
    IBTK::SAMRAIPointer<IBStrategy> d_ib_method_ops, d_ibfe_method_ops;
