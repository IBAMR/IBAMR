 ...
 * </ul>
 */
class IBStrategy : public SAMRAI::mesh::StandardTagAndInitStrategyNd, public SAMRAI::tbox::Serializable
{
public:
    /*!
     * \brief Constructor.
     ...
     */
    virtual const SAMRAI::hier::IntVectorNd& getMinimumGhostCellWidth() const = 0;
