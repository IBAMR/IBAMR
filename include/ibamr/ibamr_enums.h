...
{
    PIECEWISE_CONSTANT,
    BSPLINE_1 = PIECEWISE_CONSTANT,
    PIECEWISE_LINEAR,
    BSPLINE_2 = PIECEWISE_LINEAR,
    BSPLINE_3,
    BSPLINE_4,
    BSPLINE_5,
    BSPLINE_6,
...
{
    if (strcasecmp(val.c_str(), "PIECEWISE_CONSTANT") == 0) return PIECEWISE_CONSTANT;
    if (strcasecmp(val.c_str(), "BSPLINE_1") == 0) return BSPLINE_1;
    if (strcasecmp(val.c_str(), "PIECEWISE_LINEAR") == 0) return PIECEWISE_LINEAR;
    if (strcasecmp(val.c_str(), "BSPLINE_2") == 0) return BSPLINE_2;
...
{
    if (val == PIECEWISE_CONSTANT) return "PIECEWISE_CONSTANT";
