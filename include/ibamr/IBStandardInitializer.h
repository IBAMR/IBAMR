...
public:
     ...
     * \brief Constructor.
     */
    IBStandardInitializer(std::string object_name, IBTK::SAMRAIPointer<SAMRAI::tbox::Database> input_db);
...
private:
     ...
     */
    std::vector<IBTK::SAMRAIPointer<IBTK::Streamable> > initializeNodeData(const std::pair<int, int>& point_index,
