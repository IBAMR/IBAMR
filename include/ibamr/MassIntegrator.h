...
{
/*!
 * \brief Class MassIntegrator integrates
 ...
 * \f$ \nabla \cdot (\rho u T)\f$.
 *
 * Class MassIntegrator computes the convective
...
public:
    ...
    /*!
     * \brief get RHS of continuity equation numerically
     */
...
private:
     ...
     * \brief Compute the interpolation of a quantity Q onto Q_half, faces of the cell centered control volumes
     */
    void computeRHSOfContinuityEquation(const double dt);
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceVariable<NDIM, double> > d_rho_extrap_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM, double> > d_div_U_N_var;
    int d_rho_extrap_idx, d_div_U_N_idx;
};
} // namespace IBAMR
