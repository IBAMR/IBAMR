...
public:
     ...
     * element mesh.
     */
    virtual void registerDirectForcingKinematics(const SAMRAIPointer<IBAMR::IBFEDirectForcingKinematics>& data,
                                                 unsigned int part = 0);
     ...
     */
    void addWorkloadEstimate(SAMRAIPointer<SAMRAIPatchHierarchy> hierarchy, int workload_data_idx) override;
     ...
     */
    SAMRAIPointer<SAMRAIBasePatchHierarchy> getScratchHierarchy();
...
protected:
     ...
     */
    SAMRAIRefineSchedule& getProlongationSchedule(int level_number, int coarse_data_idx, int fine_data_idx);

    /*!
     * Cached input databases.
     */
    SAMRAIPointer<SAMRAIDatabase> d_fe_data_manager_db;
    ...
    SAMRAIPointer<SAMRAIVariable> d_lagrangian_workload_var;
...
private:
     ...
     */
    void commonConstructor(const SAMRAIPointer<SAMRAIDatabase>& input_db, int max_levels);
