...
protected:
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM, double> > d_bulk_viscosity_cc_var;
    SAMRAI::tbox::Pointer<SAMRAI::pdat::SideVariable<NDIM, double> > d_bulk_viscosity_sc_var;
    ...
    int d_bulk_viscosity_cc_idx, d_bulk_viscosity_sc_idx;
