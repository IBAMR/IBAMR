...
protected:
     ...
     */
    std::vector<IBTK::SAMRAIPointer<IBTK::LData> > d_K_data, d_M_data;
    std::vector<IBTK::SAMRAIPointer<IBTK::LData> > d_Y_current_data, d_Y_new_data;
    std::vector<IBTK::SAMRAIPointer<IBTK::LData> > d_V_current_data, d_V_new_data;
