...
#ifndef included_IBAMR_INSCollocatedVelocityBcCoef
#define included_IBAMR_INSCollocatedVelocityBcCoef
 ...
 */
class INSCollocatedVelocityBcCoef : public StokesBcCoefStrategy
{
public:
    /*!
     * \brief Constructor.
     */
    INSCollocatedVelocityBcCoef(unsigned int comp_idx,
    ...
    /*!
     * \name Extended SAMRAIRobinBcCoefStrategy interface.
     */
    //\{
     ...
     * at a patch boundary.
     *
     * \note In the original SAMRAIRobinBcCoefStrategy interface, it was
...
#endif // #ifndef included_IBAMR_INSCollocatedVelocityBcCoef
