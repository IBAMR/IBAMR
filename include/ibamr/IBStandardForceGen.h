...
public:
     ...
     */
    IBStandardForceGen(SAMRAIPointer<SAMRAIDatabase> input_db = SAMRAIPointer<SAMRAIDatabase>());
     ...
     */
    double computeLagrangianEnergy(SAMRAIPointer<IBTK::LData> X_data,
                                   SAMRAIPointer<IBTK::LData> U_data,
                                   SAMRAIPointer<SAMRAIPatchHierarchy> hierarchy,
                                   int level_number,
                                   double data_time,
...
private:
    ...
    void computeLagrangianSpringForce(SAMRAIPointer<IBTK::LData> F_data,
                                      SAMRAIPointer<IBTK::LData> X_data,
                                      SAMRAIPointer<SAMRAIPatchHierarchy> hierarchy,
                                      int level_number,
                                      double data_time,
    ...
    void initializeBeamLevelData(std::set<int>& nonlocal_petsc_idx_set,
                                 ...
                                 bool initial_time,
                                 IBTK::LDataManager* l_data_manager);
    void computeLagrangianBeamForce(SAMRAIPointer<IBTK::LData> F_data,
                                    SAMRAIPointer<IBTK::LData> X_data,
                                    SAMRAIPointer<SAMRAIPatchHierarchy> hierarchy,
                                    int level_number,
                                    double data_time,
    ...
    void initializeTargetPointLevelData(std::set<int>& nonlocal_petsc_idx_set,
                                        ...
                                        bool initial_time,
                                        IBTK::LDataManager* l_data_manager);
    void computeLagrangianTargetPointForce(SAMRAIPointer<IBTK::LData> F_data,
                                           SAMRAIPointer<IBTK::LData> X_data,
                                           SAMRAIPointer<IBTK::LData> U_data,
                                           SAMRAIPointer<SAMRAIPatchHierarchy> hierarchy,
                                           int level_number,
