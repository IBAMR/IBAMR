...
PhaseChangeHierarchyIntegrator::regridHierarchyEndSpecialized()
{
    ...
    d_T_sol = new SAMRAIVectorReal<NDIM, double>(
        d_object_name + "::sol_vec::" + d_T_var->getName(), d_hierarchy, coarsest_hier_level, finest_hier_level);
    ...
    d_T_rhs = new SAMRAIVectorReal<NDIM, double>(
        d_object_name + "::rhs_vec::" + d_T_var->getName(), d_hierarchy, coarsest_hier_level, finest_hier_level);
