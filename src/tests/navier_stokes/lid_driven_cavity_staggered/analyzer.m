...
uI32  = 0.5* u64(1:2:size( u64,1),1:2:(size( u64,2)-1)) + 0.5* u64(1:2:size( u64,1),2:2:size( u64,2));
uI64  = 0.5*u128(1:2:size(u128,1),1:2:(size(u128,2)-1)) + 0.5*u128(1:2:size(u128,1),2:2:size(u128,2));
uI128 = 0.5*u256(1:2:size(u256,1),1:2:(size(u256,2)-1)) + 0.5*u256(1:2:size(u256,1),2:2:size(u256,2));

u1_32_64 = L1normx(u32-uI32);
u1_64_128 = L1normx(u64-uI64);
u1_128_256 = L1normx(u128-uI128);

fprintf('|u32 -u64 |_1  = %2.3d  rate = %2.3f\n',u1_32_64  ,log2(u1_32_64 /u1_64_128 ));
fprintf('|u64 -u128|_1  = %2.3d  rate = %2.3f\n',u1_64_128 ,log2(u1_64_128/u1_128_256));
fprintf('|u128-u256|_1  = %2.3d  rate = ---\n\n',u1_128_256);

u2_32_64 = L2normx(u32-uI32);
u2_64_128 = L2normx(u64-uI64);
u2_128_256 = L2normx(u128-uI128);

fprintf('|u32 -u64 |_2  = %2.3d  rate = %2.3f\n',u2_32_64  ,log2(u2_32_64 /u2_64_128 ));
...
fprintf('|u128-u256|_oo = %2.3d  rate = ---\n\n',uoo_128_256);
...
vI32  = 0.5* v64(1:2:(size( v64,1)-1),1:2:size( v64,2)) + 0.5* v64(2:2:size( v64,1),1:2:size( v64,2));
vI64  = 0.5*v128(1:2:(size(v128,1)-1),1:2:size(v128,2)) + 0.5*v128(2:2:size(v128,1),1:2:size(v128,2));
vI128 = 0.5*v256(1:2:(size(v256,1)-1),1:2:size(v256,2)) + 0.5*v256(2:2:size(v256,1),1:2:size(v256,2));

v1_32_64 = L1normy(v32-vI32);
v1_64_128 = L1normy(v64-vI64);
v1_128_256 = L1normy(v128-vI128);

fprintf('|v32 -v64 |_1  = %2.3d  rate = %2.3f\n',v1_32_64  ,log2(v1_32_64 /v1_64_128 ));
fprintf('|v64 -v128|_1  = %2.3d  rate = %2.3f\n',v1_64_128 ,log2(v1_64_128/v1_128_256));
fprintf('|v128-v256|_1  = %2.3d  rate = ---\n\n',v1_128_256);

v2_32_64 = L2normy(v32-vI32);
v2_64_128 = L2normy(v64-vI64);
v2_128_256 = L2normy(v128-vI128);

fprintf('|v32 -v64 |_2  = %2.3d  rate = %2.3f\n',v2_32_64  ,log2(v2_32_64 /v2_64_128 ));
...
fprintf('|v128-v256|_oo = %2.3d  rate = ---\n\n',voo_128_256);
...
fprintf('|p128-p256|_oo = %2.3d  rate = ---\n\n',poo_128_256);
