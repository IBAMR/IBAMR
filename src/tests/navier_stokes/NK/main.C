...
#include <ibamr/INSNKHierarchyIntegrator.h>
    ...
    char* argv[])
{
    ...
    {// cleanup all smart Pointers prior to shutdown
        ...
        tbox::Pointer<INSNKHierarchyIntegrator> time_integrator =
            new INSNKHierarchyIntegrator(
                "INSNKHierarchyIntegrator",
                input_db->getDatabase("INSNKHierarchyIntegrator"),
