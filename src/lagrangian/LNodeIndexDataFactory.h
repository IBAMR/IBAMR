...
public:
    /*!
     * The default constructor for the LNodeIndexDataFactory class.
     ...
     * properties (e.g, same type and ghost cell width).  The
     ...
     * object.  The default information about the object (e.g., ghost
     * cell width) is taken from the factory.  If no memory pool is
     ...
     * allocated data.  Because the irregular data list can grow and
     * shrink, it would be impossible to estimate the necessary amount
     * of memory.  Instead, dynamic data is allocated via the standard
     * new/free mechanisms.
     */
