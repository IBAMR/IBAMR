...
// Version of INSWENOHierarchyIntegrator restart file data.
static const int INS_HIERARCHY_INTEGRATOR_VERSION = 1;
}

/////////////////////////////// PUBLIC ///////////////////////////////////////

INSWENOHierarchyIntegrator::INSWENOHierarchyIntegrator(
...
const std::string&
INSWENOHierarchyIntegrator::getName() const
{
    return d_object_name;
}// getName

void
INSWENOHierarchyIntegrator::registerVelocityInitialConditions(
...
void
INSWENOHierarchyIntegrator::registerVelocityPhysicalBcCoefs(
...
void
INSWENOHierarchyIntegrator::registerPressurePhysicalBcCoef(
...
void
INSWENOHierarchyIntegrator::registerPressureInitialConditions(
...
void
INSWENOHierarchyIntegrator::registerBodyForceSpecification(
...
void
INSWENOHierarchyIntegrator::registerDivergenceSpecification(
...
void
INSWENOHierarchyIntegrator::registerVisItDataWriter(
...
void
INSWENOHierarchyIntegrator::registerRegridHierarchyCallback(
...
void
INSWENOHierarchyIntegrator::registerApplyGradientDetectorCallback(
...
void
INSWENOHierarchyIntegrator::setHierarchyMathOps(
...
bool
INSWENOHierarchyIntegrator::isManagingHierarchyMathOps() const
{
...
///
///  allow the INSWENOHierarchyIntegrator to be used as a hierarchy integrator.
///

void
INSWENOHierarchyIntegrator::initializeHierarchyIntegrator(
    SAMRAI::tbox::Pointer<SAMRAI::mesh::GriddingAlgorithm<NDIM> > gridding_alg)
{
    ...
    //
    // All other data is managed by the INSWENOHierarchyIntegrator.
...
//          }
    ...
    // data.
    //
    // NOTE: All state data managed by class INSWENOHierarchyIntegrator is
...
double
INSWENOHierarchyIntegrator::initializeHierarchy()
{
...
double
INSWENOHierarchyIntegrator::advanceHierarchy(
    const double dt)
{
...
double
INSWENOHierarchyIntegrator::getStableTimestep()
{
...
bool
INSWENOHierarchyIntegrator::atRegridPoint() const
{
...
double
INSWENOHierarchyIntegrator::getIntegratorTime() const
{
    return d_integrator_time;
}// getIntegratorTime

double
INSWENOHierarchyIntegrator::getStartTime() const
{
    return d_start_time;
}// getStartTime

double
INSWENOHierarchyIntegrator::getEndTime() const
{
    return d_end_time;
}// getEndTime

int
INSWENOHierarchyIntegrator::getIntegratorStep() const
{
    return d_integrator_step;
}// getIntegratorStep

int
INSWENOHierarchyIntegrator::getMaxIntegratorSteps() const
{
    return d_max_integrator_steps;
}// getMaxIntegratorSteps

bool
INSWENOHierarchyIntegrator::stepsRemaining() const
{
    return (d_integrator_step < d_max_integrator_steps);
}// stepsRemaining

const SAMRAI::tbox::Pointer<SAMRAI::hier::PatchHierarchy<NDIM> >
INSWENOHierarchyIntegrator::getPatchHierarchy() const
{
    return d_hierarchy;
}// getPatchHierarchy

SAMRAI::tbox::Pointer<SAMRAI::mesh::GriddingAlgorithm<NDIM> >
INSWENOHierarchyIntegrator::getGriddingAlgorithm() const
{
    return d_gridding_alg;
}// getGriddingAlgorithm

SAMRAI::tbox::Pointer<GodunovAdvector>
INSWENOHierarchyIntegrator::getGodunovAdvector() const
{
    return d_explicit_predictor;
}// getGodunovAdvector

SAMRAI::tbox::Pointer<AdvDiffHierarchyIntegrator>
INSWENOHierarchyIntegrator::getAdvDiffHierarchyIntegrator() const
{
    return d_adv_diff_hier_integrator;
}// getAdvDiffHierarchyIntegrator

SAMRAI::tbox::Pointer<HierarchyProjector>
INSWENOHierarchyIntegrator::getHierarchyProjector() const
{
...
///      resetHierDataToPreadvanceState()
///
///  allow the INSWENOHierarchyIntegrator to provide data management for a time
///  integrator which making use of this class.
///

void
INSWENOHierarchyIntegrator::regridHierarchy()
{
    ...
    else if (d_reproject_after_regrid && !initial_time)
    {
        ...
        d_hier_math_ops->grad(
            ...
            d_regrid_Phi_hier_bdry_fill_op, d_integrator_time);
        ...
        d_hier_cc_data_ops->axpy(d_U_current_idx, -d_old_dt/d_rho, d_Grad_Phi_idx, d_U_star_current_idx);
    }
...
void
INSWENOHierarchyIntegrator::predictAdvectionVelocity(
    ...
    const double new_time)
{
    ...
    d_hier_math_ops->grad(
        ...
        d_P_hier_bdry_fill_op, current_time);
...
void
INSWENOHierarchyIntegrator::integrateAdvDiff(
    const double current_time,
    const double new_time)
{
...
void
INSWENOHierarchyIntegrator::projectVelocity(
    const double current_time,
    const double new_time)
{
    ...
    // Compute u^(*) from U^(*).
    d_hier_cc_data_ops->copyData(d_V_idx, d_U_star_new_idx);
    d_hier_math_ops->interp(
        d_u_scratch_idx, d_u_var, // u(*)
        false,                    // do not synch u(*) coarse-fine bdry
        d_V_idx        , d_V_var, // U(*)
...
void
INSWENOHierarchyIntegrator::updatePressure(
    const double current_time,
    const double new_time,
...
void
INSWENOHierarchyIntegrator::synchronizeHierarchy()
{
...
void
INSWENOHierarchyIntegrator::synchronizeNewLevels(
...
void
INSWENOHierarchyIntegrator::resetTimeDependentHierData(
    const double new_time)
{
...
void
INSWENOHierarchyIntegrator::resetHierDataToPreadvanceState()
{
...
void
INSWENOHierarchyIntegrator::initializeLevelData(
    ...
    if (initial_time)
    {
        ...
        else
        {
            ...
            for (SAMRAI::hier::PatchLevel<NDIM>::Iterator p(level); p; p++)
            {
                ...
                patch_math_ops.interp(u_current_data, U_scratch_data, patch);
            ...
            if (!d_Div_u_var.isNull())
            {
                for (SAMRAI::hier::PatchLevel<NDIM>::Iterator p(level); p; p++)
                {
                    ...
                    patch_math_ops.div(Div_u_current_data, 1.0, u_current_data, 0.0, SAMRAI::tbox::Pointer<SAMRAI::pdat::CellData<NDIM,double> >(NULL), patch);
                }
            }
            if (!d_Div_u_adv_var.isNull())
            {
                for (SAMRAI::hier::PatchLevel<NDIM>::Iterator p(level); p; p++)
                {
                    ...
                    patch_math_ops.div(Div_u_adv_current_data, 1.0, u_adv_current_data, 0.0, SAMRAI::tbox::Pointer<SAMRAI::pdat::CellData<NDIM,double> >(NULL), patch);
                }
            }
...
void
INSWENOHierarchyIntegrator::resetHierarchyConfiguration(
    const SAMRAI::tbox::Pointer<SAMRAI::hier::BasePatchHierarchy<NDIM> > base_hierarchy,
    const int coarsest_level,
    const int finest_level)
{
...
void
INSWENOHierarchyIntegrator::applyGradientDetector(
...
INSWENOHierarchyIntegrator::getVelocityVar()
{
    return d_U_var;
}// getVelocityVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM,double> >
INSWENOHierarchyIntegrator::getPressureVar()
{
    return d_P_var;
}// getPressureVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceVariable<NDIM,double> >
INSWENOHierarchyIntegrator::getAdvectionVelocityVar()
{
    return d_u_adv_var;
}// getAdvectionVelocityVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM,double> >
INSWENOHierarchyIntegrator::getForceVar()
{
    return d_F_var;
}// getForceVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM,double> >
INSWENOHierarchyIntegrator::getDivergenceVar()
{
    return d_Q_var;
}// getDivergenceVar
...
INSWENOHierarchyIntegrator::getCurrentContext() const
{
    return d_adv_diff_hier_integrator->getCurrentContext();
}// getCurrentContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSWENOHierarchyIntegrator::getNewContext() const
{
    return d_adv_diff_hier_integrator->getNewContext();
}// getNewContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSWENOHierarchyIntegrator::getOldContext() const
{
    return d_adv_diff_hier_integrator->getOldContext();
}// getOldContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSWENOHierarchyIntegrator::getScratchContext() const
{
    return d_adv_diff_hier_integrator->getScratchContext();
}// getScratchContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSWENOHierarchyIntegrator::getPlotContext() const
{
...
void
INSWENOHierarchyIntegrator::putToDatabase(
...
void
INSWENOHierarchyIntegrator::printClassData(
    std::ostream& os) const
{
    os << "\nINSWENOHierarchyIntegrator::printClassData..." << endl;
    os << "this = " << const_cast<INSWENOHierarchyIntegrator*>(this) << endl;
...
void
INSWENOHierarchyIntegrator::registerVariable(
    int& current_idx,
    int& new_idx,
    int& scratch_idx,
...
void
INSWENOHierarchyIntegrator::computeDivSourceTerm(
    const int F_idx,
    const int Q_idx,
    const int u_idx,
...
void
INSWENOHierarchyIntegrator::getFromInput(
    SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> db,
...
void
INSWENOHierarchyIntegrator::getFromRestart()
{
...
template class SAMRAI::tbox::Pointer<IBAMR::INSWENOHierarchyIntegrator>;
