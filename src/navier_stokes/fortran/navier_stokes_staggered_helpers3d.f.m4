...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine navier_stokes_sc_regrid_copy3d(
     &     u_dst0,u_dst1,u_dst2,u_dst_gcw,
     &     u_src0,u_src1,u_src2,u_src_gcw,
...
c
      ...
      REAL u_src0(SIDE3d0(ilower,iupper,u_src_gcw))
      REAL u_src1(SIDE3d1(ilower,iupper,u_src_gcw))
      REAL u_src2(SIDE3d2(ilower,iupper,u_src_gcw))

      INTEGER indicator(CELL3d(ilower,iupper,indicator_gcw))
c
c     Input/Output.
c
      REAL u_dst0(SIDE3d0(ilower,iupper,u_dst_gcw))
      REAL u_dst1(SIDE3d1(ilower,iupper,u_dst_gcw))
      REAL u_dst2(SIDE3d2(ilower,iupper,u_dst_gcw))
c
c     Local variables.
c
      INTEGER i0,i1,i2
      ...
      do i2 = ilower2,iupper2
         do i1 = ilower1,iupper1
            do i0 = ilower0,iupper0+1
               if ( (indicator(i0-1,i1,i2).eq.1) .or.
     &              (indicator(i0  ,i1,i2).eq.1) ) then
                  u_dst0(i0,i1,i2) = u_src0(i0,i1,i2)
               endif
            enddo
         enddo
      enddo
      ...
      do i2 = ilower2,iupper2
         do i1 = ilower1,iupper1+1
            do i0 = ilower0,iupper0
               if ( (indicator(i0,i1-1,i2).eq.1) .or.
     &              (indicator(i0,i1  ,i2).eq.1) ) then
                  u_dst1(i0,i1,i2) = u_src1(i0,i1,i2)
               endif
            enddo
         enddo
      enddo
      ...
      do i2 = ilower2,iupper2+1
         do i1 = ilower1,iupper1
            do i0 = ilower0,iupper0
               if ( (indicator(i0,i1,i2-1).eq.1) .or.
     &              (indicator(i0,i1,i2  ).eq.1) ) then
                  u_dst2(i0,i1,i2) = u_src2(i0,i1,i2)
               endif
            enddo
         enddo
      enddo
