...
// Last modified: <10.Jul.2007 11:55:56 boyce@bigboy.nyconnect.com>
...
// Version of INSHierarchyIntegrator2 restart file data.
static const int INS_HIERARCHY_INTEGRATOR_VERSION = 1;
}

/////////////////////////////// PUBLIC ///////////////////////////////////////

INSHierarchyIntegrator2::INSHierarchyIntegrator2(
    ...
    bool register_for_restart)
{
    ...
    if (timers_need_init)
    {
        t_initialize_hierarchy_integrator = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::initializeHierarchyIntegrator()");
        t_initialize_hierarchy = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::initializeHierarchy()");
        t_advance_hierarchy = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::advanceHierarchy()");
        t_get_stable_timestep = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::getStableTimestep()");
        t_regrid_hierarchy = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::regridHierarchy()");
        t_predict_advection_velocity = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::predictAdvectionVelocity()");
        t_integrate_adv_diff = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::integrateAdvDiff()");
        t_project_velocity = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::projectVelocity()");
        t_update_pressure = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::updatePressure()");
        t_synchronize_hierarchy = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::synchronizeHierarchy()");
        t_synchronize_new_levels = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::synchronizeNewLevels()");
        t_reset_time_dependent_data = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::resetTimeDependentHierData()");
        t_reset_data_to_preadvance_state = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::resetHierDataToPreadvanceState()");
        t_initialize_level_data = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::initializeLevelData()");
        t_reset_hierarchy_configuration = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::resetHierarchyConfiguration()");
        t_apply_gradient_detector = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::applyGradientDetector()");
        t_put_to_database = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::putToDatabase()");
        t_compute_div_source_term = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::computeDivSourceTerm()");
        t_reset_cell_velocity_boundary_conditions = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::resetCellVelocityBoundaryConditions()");
        t_reset_mac_velocity_boundary_conditions = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::INSHierarchyIntegrator2::resetMACVelocityBoundaryConditions()");
        timers_need_init = false;
    }
    return;
}// INSHierarchyIntegrator2
...
const std::string&
INSHierarchyIntegrator2::getName() const
{
    return d_object_name;
}// getName

void
INSHierarchyIntegrator2::registerVelocityInitialConditions(
...
void
INSHierarchyIntegrator2::registerVelocityPhysicalBcCoefs(
...
void
INSHierarchyIntegrator2::registerPressureInitialConditions(
...
void
INSHierarchyIntegrator2::registerBodyForceSpecification(
...
void
INSHierarchyIntegrator2::registerVisItDataWriter(
...
INSHierarchyIntegrator2::getHierarchyMathOps() const
{
#ifdef DEBUG_CHECK_ASSERTIONS
...
void
INSHierarchyIntegrator2::setHierarchyMathOps(
...
bool
INSHierarchyIntegrator2::isManagingHierarchyMathOps() const
{
...
///
///  allow class INSHierarchyIntegrator2 to be used as a hierarchy integrator.
///

void
INSHierarchyIntegrator2::initializeHierarchyIntegrator(
    SAMRAI::tbox::Pointer<SAMRAI::mesh::GriddingAlgorithm<NDIM> > gridding_alg)
{
    ...
    //
    // Data corresponding to U, U~, Grad_P, and u_adv is maintained by the
    // AdvDiffHierarchyIntegrator.
    //
    // All other data is managed by class INSHierarchyIntegrator2.
    ...
    d_U_tilde_var = new SAMRAI::pdat::CellVariable<NDIM,double>(d_object_name+"::U_tilde",NDIM);
    d_u_tilde_var = new SAMRAI::pdat::FaceVariable<NDIM,double>(d_object_name+"::u_tilde");
    ...
    registerVariable(d_u_tilde_current_idx, d_u_tilde_new_idx, d_u_tilde_scratch_idx,
                     d_u_tilde_var, face_ghosts,
                     "CONSERVATIVE_COARSEN",
                     "CONSERVATIVE_LINEAR_REFINE");
    ...
    static const bool u_adv_is_div_free = true;
    ...
    assert(d_F_set.isNull());

    d_adv_diff_hier_integrator->
        registerAdvectedAndDiffusedQuantity(
            d_U_tilde_var, d_nu, d_lambda, d_conservation_form,
            d_U_init, d_U_bc_coefs,
            d_grad_Phi_var);
    ...
    d_U_tilde_current_idx = var_db->mapVariableAndContextToIndex(
        d_U_tilde_var, getCurrentContext());
    d_U_tilde_scratch_idx = var_db->mapVariableAndContextToIndex(
        d_U_tilde_var, getScratchContext());
    d_U_tilde_new_idx = var_db->mapVariableAndContextToIndex(
        d_U_tilde_var, getNewContext());
    ...
    d_ralgs["Phi->Phi::CONSTANT_REFINE"]->
        registerRefine(d_Phi_idx, // destination
                       d_Phi_idx, // source
                       d_Phi_idx, // temporary work space
                       refine_operator);
    //d_rstrategies["Phi->Phi::CONSTANT_REFINE"] =
    //    new STOOLS::CartExtrapPhysBdryOp(d_Phi_idx, "LINEAR");
    ...
    // Setup hybrid projection solvers and preconditioners.
    d_helmholtz4_spec = new SAMRAI::solv::PoissonSpecifications(d_object_name+"::helmholtz4_spec");
    d_helmholtz4_op = new STOOLS::CCLaplaceOperator(d_object_name+"::helmholtz4_op",*d_helmholtz4_spec,NULL); // XXXX
    d_helmholtz4_solver = new STOOLS::PETScKrylovLinearSolver(d_object_name+"::helmholtz4_solver", "adv_diff_");
    d_helmholtz4_solver->setInitialGuessNonzero(true);
    d_helmholtz4_solver->setOperator(d_helmholtz4_op);

    // Indicate the the solver need to be initialized.
    d_helmholtz_solver_need_init = true;
...
double
INSHierarchyIntegrator2::initializeHierarchy()
{
...
double
INSHierarchyIntegrator2::advanceHierarchy(
    const double dt)
{
...
double
INSHierarchyIntegrator2::getStableTimestep()
{
...
bool
INSHierarchyIntegrator2::atRegridPoint() const
{
...
double
INSHierarchyIntegrator2::getIntegratorTime() const
{
    return d_integrator_time;
}// getIntegratorTime

double
INSHierarchyIntegrator2::getStartTime() const
{
    return d_start_time;
}// getStartTime

double
INSHierarchyIntegrator2::getEndTime() const
{
    return d_end_time;
}// getEndTime

int
INSHierarchyIntegrator2::getIntegratorStep() const
{
    return d_integrator_step;
}// getIntegratorStep

int
INSHierarchyIntegrator2::getMaxIntegratorSteps() const
{
    return d_max_integrator_steps;
}// getMaxIntegratorSteps

bool
INSHierarchyIntegrator2::stepsRemaining() const
{
    return (d_integrator_step < d_max_integrator_steps);
}// stepsRemaining

const SAMRAI::tbox::Pointer<SAMRAI::hier::PatchHierarchy<NDIM> >
INSHierarchyIntegrator2::getPatchHierarchy() const
{
    return d_hierarchy;
}// getPatchHierarchy

SAMRAI::tbox::Pointer<SAMRAI::mesh::GriddingAlgorithm<NDIM> >
INSHierarchyIntegrator2::getGriddingAlgorithm() const
{
    return d_gridding_alg;
}// getGriddingAlgorithm

SAMRAI::tbox::Pointer<GodunovAdvector>
INSHierarchyIntegrator2::getGodunovAdvector() const
{
    return d_explicit_predictor;
}// getGodunovAdvector

SAMRAI::tbox::Pointer<AdvDiffHierarchyIntegrator>
INSHierarchyIntegrator2::getAdvDiffHierarchyIntegrator() const
{
    return d_adv_diff_hier_integrator;
}// getAdvDiffHierarchyIntegrator

SAMRAI::tbox::Pointer<HierarchyProjector>
INSHierarchyIntegrator2::getHierarchyProjector() const
{
...
///      resetHierDataToPreadvanceState()
///
///  allow class INSHierarchyIntegrator2 to provide data management for a time
///  integrator which making use of this class.
///

void
INSHierarchyIntegrator2::regridHierarchy()
{
...
void
INSHierarchyIntegrator2::predictAdvectionVelocity(
    ...
    const double new_time)
{
    ...
    // We project the velocity at the start time.
    if (d_performing_init_cycles && d_cycle == 0)
    {
        // Interpolate U(*)->u(*).
        ...
        d_hier_cc_data_ops->subtract(d_U_current_idx, d_U_current_idx, d_Grad_Phi_idx);
    }

    // Initialize U_tilde(n) to equal U(n).
    d_hier_cc_data_ops->copyData(d_U_tilde_current_idx, d_U_current_idx);
    ...
    if (!d_F_var.isNull())
    {
        d_hier_cc_data_ops->axpy(d_G_idx, 1.0/d_rho, d_F_current_idx, d_Grad_P_current_idx);
    }
    else
    {
...
void
INSHierarchyIntegrator2::integrateAdvDiff(
    const double current_time,
    const double new_time)
{
    ...
    for (int ln = coarsest_ln; ln <= finest_ln; ++ln)
    {
        d_rscheds["grad_Phi->grad_Phi::CONSERVATIVE_LINEAR_REFINE"][ln]->fillData(current_time);
    }
    ...
    if (!d_F_set.isNull())
    {
        ...
        d_hier_cc_data_ops->axpy(d_Grad_P_current_idx, +0.5/d_rho, d_F_current_idx, d_Grad_P_current_idx);
        d_hier_cc_data_ops->axpy(d_Grad_P_current_idx, +0.5/d_rho, d_F_new_idx    , d_Grad_P_current_idx);
    }
...
void
INSHierarchyIntegrator2::projectVelocity(
    const double current_time,
    const double new_time)
{
    ...
    d_hier_cc_data_ops->subtract(d_U_new_idx, d_U_new_idx, d_Grad_Phi_idx);

    // Compute u~^(*) from U~^(*).
    grid_geom = d_hierarchy->getGridGeometry();
    bdry_fill_op = grid_geom->lookupRefineOperator(d_U_tilde_var, "CONSTANT_REFINE");
    bdry_fill_alg = new SAMRAI::xfer::RefineAlgorithm<NDIM>();
    bdry_fill_alg->registerRefine(d_V_idx,           // destination
                                  d_U_tilde_new_idx, // source
                                  d_V_idx,           // temporary work space
                                  bdry_fill_op);
    ...
    d_hier_math_ops->interp(
        d_u_tilde_scratch_idx, d_u_tilde_var, // u~(*)
        true,                                 // synch u~(*) coarse-fine bdry
        d_V_idx              , d_V_var      , // U~(*)
        d_rscheds["U->V::C->S::CONSTANT_REFINE"],
        new_time);                            // data time
    ...
    d_hier_projector->projectHierarchy(
        d_rho, dt,
        d_u_tilde_new_idx    , d_u_tilde_var , // u~(n+1)
        d_Phi_idx            , d_Phi_var     , // Phi
        d_rscheds["Phi->Phi::CONSTANT_REFINE"],
        current_time,                          // Phi data time
        d_grad_Phi_idx       , d_grad_Phi_var, // grad Phi
        d_u_tilde_scratch_idx, d_u_tilde_var , // u~(n+1,*)
        d_rscheds["NONE"],                     // no fill needed
        current_time,                          // u_tilde_scratch data time
        false);                                // do not synch u~(n+1,*) coarse-fine bdry
    ...
    d_hier_cc_data_ops->subtract(d_U_tilde_new_idx, d_U_tilde_new_idx, d_Grad_Phi_idx);
...
void
INSHierarchyIntegrator2::updatePressure(
    const double current_time,
    const double new_time,
    const bool override_current_pressure)
{
    ...
    SAMRAI::tbox::pout << "P_current min = " << d_hier_cc_data_ops->min(d_P_current_idx) << endl;
    SAMRAI::tbox::pout << "P_current max = " << d_hier_cc_data_ops->max(d_P_current_idx) << endl;

    SAMRAI::tbox::pout << "Phi min = " << d_hier_cc_data_ops->min(d_Phi_idx) << endl;
    SAMRAI::tbox::pout << "Phi max = " << d_hier_cc_data_ops->max(d_Phi_idx) << endl;

    // Setup the rhs to solve for the second-order pressure update.
    const double a = 2.0 - sqrt(2.0);
    const double nu1 = 0.5*(a-sqrt(a*a-4.0*a+2.0));
    const double nu4 = (0.5-a);

    SAMRAI::solv::PoissonSpecifications helmholtz1_spec("helmholtz1_spec");
    helmholtz1_spec.setCConstant(1.0+nu1*dt*d_lambda);
    helmholtz1_spec.setDConstant(   -nu1*dt*d_nu    );

    d_helmholtz4_spec->setCConstant(1.0-nu4*dt*d_lambda);
    ...
    if (!SAMRAI::tbox::Utilities::deq(dt,d_old_dt) || d_helmholtz_solver_need_init)
    {
        d_helmholtz4_solver->setInitialGuessNonzero(true);
        d_helmholtz4_solver->setOperator(d_helmholtz4_op);
        d_helmholtz4_solver->initializeSolverState(*d_sol_vec,*d_rhs_vec);
        d_helmholtz_solver_need_init = false;
    }
    ...
    d_hier_cc_data_ops->copyData(d_Phi_idx, d_rhs_idx);
    ...
    // Solve for the second-order pressure update.
    d_hier_cc_data_ops->copyData(d_sol_idx, d_Phi_idx);
    ...
    SAMRAI::tbox::pout << "P_new min = " << d_hier_cc_data_ops->min(d_P_new_idx) << endl;
    SAMRAI::tbox::pout << "P_new max = " << d_hier_cc_data_ops->max(d_P_new_idx) << endl;
...
void
INSHierarchyIntegrator2::synchronizeHierarchy()
{
...
void
INSHierarchyIntegrator2::synchronizeNewLevels(
...
void
INSHierarchyIntegrator2::resetTimeDependentHierData(
    const double new_time)
{
...
void
INSHierarchyIntegrator2::resetHierDataToPreadvanceState()
{
...
void
INSHierarchyIntegrator2::initializeLevelData(
    ...
    if (initial_time)
    {
        ...
        if (d_U_init.isNull())
        {
            for (SAMRAI::hier::PatchLevel<NDIM>::Iterator p(level); p; p++)
            {
                ...
                SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceData<NDIM,double> > u_tilde_current_data = patch->
                    getPatchData(d_u_tilde_current_idx);
                SAMRAI::tbox::Pointer<SAMRAI::pdat::CellData<NDIM,double> > U_tilde_current_data = patch->
                    getPatchData(d_U_tilde_current_idx);

                u_tilde_current_data->fillAll(0.0);
                U_tilde_current_data->fillAll(0.0);
            }
            if (!d_Omega_var.isNull())
            {
        ...
        else
        {
            ...
            ralg->createSchedule(level, level_number-1, hierarchy, NULL)->fillData(init_data_time);
            ...
            for (SAMRAI::hier::PatchLevel<NDIM>::Iterator p(level); p; p++)
            {
                ...
                SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceData<NDIM,double> > u_tilde_current_data =
                    patch->getPatchData(d_u_tilde_current_idx);
                SAMRAI::tbox::Pointer<SAMRAI::pdat::CellData<NDIM,double> > U_tilde_current_data =
                    patch->getPatchData(d_U_tilde_current_idx);

                u_tilde_current_data->copy(*u_current_data);
                U_tilde_current_data->copy(*U_current_data);
            }
...
void
INSHierarchyIntegrator2::resetHierarchyConfiguration(
    const SAMRAI::tbox::Pointer<SAMRAI::hier::BasePatchHierarchy<NDIM> > base_hierarchy,
    const int coarsest_level,
    const int finest_level)
{
    ...
    // Indicate that the Helmholtz solver must be re-initialized.
    d_helmholtz_solver_need_init = true;
...
void
INSHierarchyIntegrator2::applyGradientDetector(
...
INSHierarchyIntegrator2::getVelocityVar()
{
    return d_U_var;
}// getVelocityVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM,double> >
INSHierarchyIntegrator2::getPressureVar()
{
    return d_P_var;
}// getPressureVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceVariable<NDIM,double> >
INSHierarchyIntegrator2::getAdvectionVelocityVar()
{
    return d_u_adv_var;
}// getAdvectionVelocityVar

SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM,double> >
INSHierarchyIntegrator2::getForceVar()
{
    return d_F_var;
}// getForceVar
...
INSHierarchyIntegrator2::getCurrentContext() const
{
    return d_adv_diff_hier_integrator->getCurrentContext();
}// getCurrentContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSHierarchyIntegrator2::getNewContext() const
{
    return d_adv_diff_hier_integrator->getNewContext();
}// getNewContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSHierarchyIntegrator2::getOldContext() const
{
    return d_adv_diff_hier_integrator->getOldContext();
}// getOldContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSHierarchyIntegrator2::getScratchContext() const
{
    return d_adv_diff_hier_integrator->getScratchContext();
}// getScratchContext

SAMRAI::tbox::Pointer<SAMRAI::hier::VariableContext>
INSHierarchyIntegrator2::getPlotContext() const
{
...
void
INSHierarchyIntegrator2::putToDatabase(
...
void
INSHierarchyIntegrator2::printClassData(
    std::ostream& os) const
{
    os << "\nINSHierarchyIntegrator2::printClassData..." << endl;
    os << "this = " << const_cast<INSHierarchyIntegrator2*>(this) << endl;
...
void
INSHierarchyIntegrator2::registerVariable(
    int& current_idx,
    int& new_idx,
    int& scratch_idx,
...
/////////////////////////////// PRIVATE //////////////////////////////////////
void
INSHierarchyIntegrator2::getFromInput(
    SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> db,
...
void
INSHierarchyIntegrator2::getFromRestart()
{
...
template class SAMRAI::tbox::Pointer<IBAMR::INSHierarchyIntegrator2>;
