...
// FORTRAN ROUTINES // All these will be moved to the child classes
#if (NDIM == 2)
...
int
LevelSetSurfaceTensionForceFunction::getMinimumGhostWidth(const std::string& kernel_fcn) const
{
    if (kernel_fcn == "none")
    {
        return 2;
