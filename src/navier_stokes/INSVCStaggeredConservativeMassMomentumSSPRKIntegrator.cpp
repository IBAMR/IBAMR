    ...
    : d_object_name(std::move(object_name)), d_u_sc_bc_coefs(NDIM), d_rho_sc_bc_coefs(NDIM)
{
    ...
    default:
        TBOX_ERROR(
            ...
            << "  valid choices are: SSPRK2, SSPRK3\n");
    }

    VariableDatabase<NDIM>* var_db = VariableDatabase<NDIM>::getDatabase();
    Pointer<VariableContext> context =
        var_db->getContext("INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::CONTEXT");

    const std::string V_var_name = "INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::V";
    ...
    const std::string rho_sc_name = "INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::RHO_SIDE_CENTERED";
    ...
    const std::string S_var_name = "INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::S";
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::initializeTimeIntegrator(
    Pointer<BasePatchHierarchy<NDIM> > base_hierarchy)
{
    ...
    {
        d_hier_math_ops =
            new HierarchyMathOps("INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::HierarchyMathOps",
                                 d_hierarchy,
                                 d_coarsest_ln,
                                 d_finest_ln);
    }
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::deallocateTimeIntegrator()
{
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setSideCenteredDensityPatchDataIndex(int rho_sc_idx)
{
#if !defined(NDEBUG)
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setSideCenteredConvectiveDerivativePatchDataIndex(int N_sc_idx)
{
#if !defined(NDEBUG)
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setMassConservationPatchDataIndex(int M_idx)
{
#if !defined(NDEBUG)
    TBOX_ASSERT(M_idx >= 0);
#endif
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setSideCenteredVelocityBoundaryConditions(
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setSideCenteredDensityBoundaryConditions(
...
int
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::getUpdatedSideCenteredDensityPatchDataIndex()
{
#if !defined(NDEBUG)
    TBOX_ASSERT(d_rho_sc_new_idx >= 0);
#endif
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setMassDensitySourceTerm(const Pointer<CartGridFunction> S_fcn)
{
#if !defined(NDEBUG)
    TBOX_ASSERT(S_fcn);
#endif
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setAnalyticalDensityFunc(const Pointer<CartGridFunction> rho_fcn)
{
#if !defined(NDEBUG)
    TBOX_ASSERT(rho_fcn);
#endif
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setFluidVelocityPatchDataIndices(int V_old_idx,
                                                                                        int V_current_idx,
                                                                                        int V_new_idx)
{
#if !defined(NDEBUG)
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setCycleNumber(int cycle_num)
{
#if !defined(NDEBUG)
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setSolutionTime(double solution_time)
{
    d_solution_time = solution_time;
} // setSolutionTime

void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setTimeInterval(double current_time, double new_time)
{
...
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::getTimeInterval() const
{
    return std::make_pair(d_current_time, d_new_time);
} // getTimeInterval

double
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::getDt() const
{
    return d_new_time - d_current_time;
} // getDt

void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setHierarchyMathOps(Pointer<HierarchyMathOps> hier_math_ops)
{
...
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::getHierarchyMathOps() const
{
    return d_hier_math_ops;
} // getHierarchyMathOps

void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::setPreviousTimeStepSize(double dt_prev)
{
#if !defined(NDEBUG)
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::computeAdvectionVelocity(
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::interpolateSideQuantity(
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::computeConvectiveDerivative(
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::computeDensityUpdate(
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::computeMassConservationMagnitude(
    Pointer<SideData<NDIM, double> > R_data,
...
void
INSVCStaggeredConservativeMassMomentumSSPRKIntegrator::enforceDivergenceFreeConditionAtCoarseFineInterface(int U_idx)
{
#if !defined(NDEBUG)
