...
// Last modified: <22.Jul.2008 17:40:20 griffith@box230.cims.nyu.edu>
 ...
 * for the staggered grid incompressible Navier-Stokes solver.
 *
 * This class interprets pure Dirichlet boundary conditions on the velocity as
 * specified velocity boundary conditions, whereas pure Neumann boundary
 * conditions are interpreted as specified traction (stress) boundary
 * conditions.  Mixed boundary conditions are not supported.
 *
 * XXXX: Current implementation of traction boundary conditions result in 1st
...
public:
     ...
     * \param P_idx           Patch data descriptor index for the cell-centered pressure P
...
private:
    ...
    /*
     * The patch data index corresponding to the current value of the pressure
     * P.
     */
    int d_P_idx;
