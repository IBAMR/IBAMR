...
// Last modified: <22.Jul.2008 17:56:32 griffith@box230.cims.nyu.edu>
...
private:
    ...
    SAMRAI::tbox::Pointer<IBTK::HierarchyGhostCellInterpolation> d_U_P_bdry_bc_fill_op, d_U_bdry_extrap_fill_op, d_no_fill_op;
