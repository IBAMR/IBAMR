...
// Last modified: <24.Nov.2008 12:33:42 griffith@box230.cims.nyu.edu>
...
private:
    ...
    SAMRAI::tbox::Pointer<IBTK::HierarchyGhostCellInterpolation> d_U_bdry_bc_fill_op, d_U_extrap_fill_op, d_no_fill_op;
