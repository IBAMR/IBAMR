    ...
    : ConvectiveOperator(std::move(object_name), difference_form)
{
    ...
    IBAMR_DO_ONCE(
        t_apply_convective_operator =
            SAMRAITimerManager::getManager()->getTimer("IBAMR::INSCollocatedCenteredConvectiveOperator::"
                                                       "applyConvectiveOperator()");
        t_apply = SAMRAITimerManager::getManager()->getTimer("IBAMR::INSCollocatedCenteredConvectiveOperator::apply()");
...
void
INSCollocatedCenteredConvectiveOperator::initializeOperatorState(const SAMRAISAMRAIVectorReal<double>& in,
