 ...
 *
 * The trapezoidal rule is employed for the implicit treatment of the
 * diffusive terms.  The advective terms are discretized by the
 * GodunovAdvector object supplied to the constructor.
 *
 * \see GodunovAdvector
