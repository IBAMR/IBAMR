...
// Last modified: <11.Apr.2007 03:48:27 boyce@trasnaform2.local>
...
{
/*!
 * \brief A specialized version of the AdvectHypPatchOps class for use with an
 * implicit time integrator for the advection-diffusion equation.
 *
