// Filename: AdvDiffTimeRefinementOps.C
// Last modified: <07.Dec.2006 12:37:50 griffith@box221.cims.nyu.edu>
// Created on 06 Dec 2006 by Boyce Griffith (griffith@box221.cims.nyu.edu)

#include "AdvDiffTimeRefinementOps.h"
...
AdvDiffTimeRefinementOps::AdvDiffTimeRefinementOps(
    ...
    : GodunovHypPatchOps(object_name, input_db, godunov_advector, grid_geom, register_for_restart)
{
    ...
    if (timers_need_init)
    {
        t_conservative_difference_on_patch = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::AdvDiffTimeRefinementOps::conservativeDifferenceOnPatch()");
        t_preprocess_advance_level_state = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::AdvDiffTimeRefinementOps::preprocessAdvanceLevelState()");
        t_postprocess_advance_level_state = SAMRAI::tbox::TimerManager::getManager()->
            getTimer("IBAMR::AdvDiffTimeRefinementOps::postprocessAdvanceLevelState()");
...
void
AdvDiffTimeRefinementOps::conservativeDifferenceOnPatch(
...
void
AdvDiffTimeRefinementOps::preprocessAdvanceLevelState(
...
void
AdvDiffTimeRefinementOps::postprocessAdvanceLevelState(
    const SAMRAI::tbox::Pointer<SAMRAI::hier::PatchLevel<NDIM> >& level,
    double current_time,
    double dt,
    bool first_step,
    ...
    bool regrid_advance)
{
    ...
    // Solve the appropriate Helmholtz equation(s) corresponding to an
    // implicit discretization of the diffusion equation.
...
template class SAMRAI::tbox::Pointer<IBAMR::AdvDiffTimeRefinementOps>;
