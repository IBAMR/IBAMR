    ...
    : AdvDiffHierarchyIntegrator(object_name, input_db, register_for_restart)
{
    ...
    d_default_convective_op_input_db = new SAMRAIMemoryDatabase(d_object_name + "::default_convective_op_input_db");
...
void
AdvDiffSemiImplicitHierarchyIntegrator::putToDatabaseSpecialized(SAMRAIPointer<SAMRAIDatabase> db)
{
...
void
AdvDiffSemiImplicitHierarchyIntegrator::getFromInput(SAMRAIPointer<SAMRAIDatabase> db, bool is_from_restart)
{
#if !defined(NDEBUG)
    TBOX_ASSERT(db);
#endif
