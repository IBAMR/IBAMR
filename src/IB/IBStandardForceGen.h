...
// Last modified: <11.Apr.2007 04:15:14 boyce@trasnaform2.local>
 ...
 * is intended to be used in conjunction with curvilinear mesh data that was
 * generated by class IBStandardInitializer.
 *
...
private:
    ...
    /*!
     * The object used to compute the beam forces.
     */
    SAMRAI::tbox::Pointer<IBBeamForceGen> d_beam_force_gen;
