...
// Last modified: <11.Apr.2007 03:59:18 boyce@trasnaform2.local>
...
{
/*!
 * Class IBHierarchyIntegrator is an implementation of a formally second-order
 * accurate, semi-implicit version of the immersed boundary method.
 */
