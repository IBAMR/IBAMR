...
WallForceEvaluator::WallForceEvaluator(SAMRAIPointer<SAMRAIDatabase> input_db,
    ...
    : d_grid_geometry(grid_geometry)
{
    ...
    SAMRAIPointer<SAMRAIDatabase> wall_db;
...
void
WallForceEvaluator::addWall(SAMRAIPointer<SAMRAIDatabase> wall_db, double wall_ghost_dist)
{
