...
// Last modified: <21.Mar.2007 19:28:32 griffith@box221.cims.nyu.edu>
...
/*!
 * @brief Class IBSpringForceGen computes the force generated by a
...
public:
    ...
    void registerSpringForceFunction(
        ...
        void (*fcn)(double F[NDIM], const double D[NDIM], const double& stf, const double& rst, const int& lag_idx));
...
private:
     ...
     * hierarchy.
     */
    std::vector<Mat> d_D_plus_mats;
    std::vector<std::vector<int> > d_lag_node_ids, d_petsc_node_ids, d_petsc_plus_ids;
     ...
     */
    std::map<int,void (*)(double F[NDIM], const double D[NDIM], const double& stf, const double& rst, const int& lag_idx)> d_edge_force_fcn_map;
};
}// namespace IBAMR
