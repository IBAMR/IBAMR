...
// Last modified: <24.Nov.2008 10:46:55 griffith@box230.cims.nyu.edu>
...
IBStaggeredHierarchyIntegrator::collectMarkersOnPatchHierarchy()
{
    ...
    for (SAMRAI::hier::PatchLevel<NDIM>::Iterator p(level); p; p++)
    {
        ...
        SAMRAI::tbox::Pointer<SAMRAI::pdat::IndexData<NDIM,IBTK::LagMarker> > new_mark_data = new SAMRAI::pdat::IndexData<NDIM,IBTK::LagMarker>(current_mark_data->getBox(), current_mark_data->getGhostCellWidth());
