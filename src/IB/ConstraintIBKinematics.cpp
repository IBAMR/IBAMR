...
namespace IBAMR
{
ConstraintIBKinematics::StructureParameters::StructureParameters(Pointer<SAMRAIDatabase> input_db,
...
void
ConstraintIBKinematics::putToDatabase(Pointer<SAMRAIDatabase> /*db*/)
{
