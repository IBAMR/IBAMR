...
// Last modified: <11.Apr.2007 03:50:28 boyce@trasnaform2.local>
...
{
/*!
 * \brief Class IBBeamForceSpec provies a mechanism for specifying the data
 * necessary to compute the forces generated by a network of linear beams.  By
 * beam, here we mean a structure that resists bending.
 *
