...
// Last modified: <11.Apr.2007 04:11:44 boyce@trasnaform2.local>
...
{
/*!
 * \brief Class IBTargetPointForceSpec provies a mechanism for specifying the
 * data necessary to compute the penalty forces generated by a collection of
 * target points.
 */
