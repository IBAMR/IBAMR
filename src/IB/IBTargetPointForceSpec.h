...
// Last modified: <21.Mar.2007 23:30:04 griffith@box221.cims.nyu.edu>
...
{
/*!
 * \brief Class IBTargetPointForceSpec provies a mechanism for
 * specifying the data necessary to compute the penalty forces
...
public:
    ...
    /*!
     * \return A const reference to the stiffness of the spring
     * attached to the target point.
     */
    const double& getStiffness() const;

    /*!
     * \return A non-const reference to the stiffness of the spring
     * attached to the target point.
     */
    double& getStiffness();

    /*!
     * \return A const reference to the position of the target point
