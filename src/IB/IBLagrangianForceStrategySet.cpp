...
void
IBLagrangianForceStrategySet::initializeLevelData(const Pointer<PatchHierarchyNd> hierarchy,
...
void
IBLagrangianForceStrategySet::computeLagrangianForceJacobianNonzeroStructure(std::vector<int>& d_nnz,
