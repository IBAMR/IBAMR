                                                               ...
                                                               Pointer<PatchLevelNd> /*level*/)
{
    ...
    Pointer<PatchDataNd> f_ib_data = patch->getPatchData(d_ib_solver->d_f_idx);
#if !defined(NDEBUG)
    TBOX_ASSERT(f_ib_data);
#endif
    Pointer<CellDataNd<double> > f_ib_cc_data = f_ib_data;
    Pointer<SideDataNd<double> > f_ib_sc_data = f_ib_data;
#if !defined(NDEBUG)
