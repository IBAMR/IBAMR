...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
c     Apply weno5 interpolation upwinding to extrapolate a cell centered
c     quantity onto the cell faces.
c
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
      subroutine weno5_extrapolate3d(
     &     ifirst0,ilast0,ifirst1,ilast1,ifirst2,ilast2,
     &     nQgc0,nQgc1,nQgc2,
     &     Q0,Q1,Q2,
     &     nugc0,nugc1,nugc2,
        ...
        do ic1 = ifirst1,ilast1
          do ic0 = ifirst0,ilast0+1
            if (u0(ic0,ic1,ic2) .ge. 0.d0) then
                QC  = Q0(ic0-1,ic1,ic2)
                QU  = Q0(ic0-2,ic1,ic2)
                QUU  = Q0(ic0-3,ic1,ic2)
                QD  = Q0(ic0,ic1,ic2)
                QDD  = Q0(ic0+1,ic1,ic2)
              else
                QC  = Q0(ic0,ic1,ic2)
                QU  = Q0(ic0+1,ic1,ic2)
                QUU  = Q0(ic0+2,ic1,ic2)
                QD  = Q0(ic0-1,ic1,ic2)
                QD  = Q0(ic0-2,ic1,ic2)
              endif
c             High-resolution scheme (HR)
              ...
              Q_WENO(1) = QD
              Q_WENO(2) = QDD
              qhalf0(ic0,ic1,ic2) = WENO5_interp(Q_WENO)
          enddo
        enddo
      enddo
c
        ...
        do ic2 = ifirst2,ilast2
          do ic1 = ifirst1,ilast1+1
            if (u1(ic1,ic2,ic0) .ge. 0.d0) then
                QC  = Q1(ic1-1,ic2,ic0)
                QU  = Q1(ic1-2,ic2,ic0)
                QUU  = Q1(ic1-3,ic2,ic0)
                QD  = Q1(ic1,ic2,ic0)
                QDD  = Q1(ic1+1,ic2,ic0)
              else
                QC  = Q1(ic1,ic2,ic0)
                QU  = Q1(ic1+1,ic2,ic0)
                QUU  = Q1(ic1+2,ic2,ic0)
                QD  = Q1(ic1-1,ic2,ic0)
                QDD  = Q1(ic1-2,ic2,ic0)
              endif
c             High-resolution scheme (HR)
              Q_WENO(-2) = QUU
              Q_WENO(-1) = QU
              ...
              Q_WENO(1) = QD
              Q_WENO(2) = QDD
              qhalf1(ic1,ic2,ic0) = WENO5_interp(Q_WENO)
          enddo
        enddo
      enddo
c
        ...
        do ic0 = ifirst0,ilast0
          do ic2 = ifirst2,ilast2+1
            if (u2(ic2,ic0,ic1) .ge. 0.d0) then
                QC  = Q2(ic2-1,ic0,ic1)
                QU  = Q2(ic2-2,ic0,ic1)
                QUU  = Q2(ic2-3,ic0,ic1)
                QD  = Q2(ic2,ic0,ic1)
                QDD  = Q2(ic2,ic0,ic1)
              else
                QC  = Q2(ic2,ic0,ic1)
                QU  = Q2(ic2+1,ic0,ic1)
                QUU  = Q2(ic2+2,ic0,ic1)
                QD  = Q2(ic2-1,ic0,ic1)
                QDD  = Q2(ic2-2,ic0,ic1)
              endif
c             High-resolution scheme (HR)
              Q_WENO(-2) = QUU
              Q_WENO(-1) = QU
              ...
              Q_WENO(1) = QD
              Q_WENO(2) = QDD
              qhalf2(ic2,ic0,ic1) = WENO5_interp(Q_WENO)
          enddo
        enddo
      enddo
c
