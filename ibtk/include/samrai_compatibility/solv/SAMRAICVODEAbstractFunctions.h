...
{
using SAMRAICVODEAbstractFunctions = SAMRAI::solv::CVODEAbstractFunctions;
} // namespace SAMRAICompatibility
} // namespace IBTK

#endif // #ifndef included_IBTK_samrai_compatibility_solv_SAMRAICVODEAbstractFunctions
