...
public:
    ...
    setNullspace(bool nullspace_contains_constant_vec,
                 const std::vector<SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > >& nullspace_basis_vecs =
                     std::vector<SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > >());
     ...
     */
    virtual const std::vector<SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > >&
...
protected:
    ...
    std::vector<SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<double> > > d_nullspace_basis_vecs;
