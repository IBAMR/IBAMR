...
#ifndef LIBMESH_ANISOTROPIC_COMPOSITE_QUADRATURE_NEWTONCOTES_H
#define LIBMESH_ANISOTROPIC_COMPOSITE_QUADRATURE_NEWTONCOTES_H
...
class QAnisotropicCompositeNewtonCotes : public QAnisotropicCompositeBase
{
 public:
   ...
   */
  QAnisotropicCompositeNewtonCotes (const unsigned int _dim,
  ...
  QAnisotropicCompositeNewtonCotes (const unsigned int d,
	 const unsigned int interval_num, const unsigned int nqp_per_interval); // only for 1D
  /**
   * Destructor.
   */
  ~QAnisotropicCompositeNewtonCotes();
...
inline
QAnisotropicCompositeNewtonCotes::QAnisotropicCompositeNewtonCotes(const unsigned int d,
...
inline
QAnisotropicCompositeNewtonCotes::~QAnisotropicCompositeNewtonCotes()
{
}
...
#endif //  LIBMESH_ANISOTROPIC_QUADRATURE_NEWTONCOTES_H
