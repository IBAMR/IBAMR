...
private:
    ...
    std::array<SAMRAI::tbox::Pointer<SAMRAI::xfer::RefineAlgorithmNd>, NDIM> d_refine_alg;
    std::array<std::vector<SAMRAI::tbox::Pointer<SAMRAI::xfer::RefineScheduleNd> >, NDIM> d_refine_scheds;
};
} // namespace IBTK
