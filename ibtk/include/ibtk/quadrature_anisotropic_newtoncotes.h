...
#ifndef LIBMESH_ANISOTROPIC_QUADRATURE_NEWTONCOTES_H
#define LIBMESH_ANISOTROPIC_QUADRATURE_NEWTONCOTES_H_H
...
// ------------------------------------------------------------
// QAnisotropicNewtonCotes class definition

class QAnisotropicNewtonCotes : public QAnisotropicBase
{
 public:
   ...
   */
  QAnisotropicNewtonCotes (const unsigned int _dim,
...
inline
QAnisotropicNewtonCotes::QAnisotropicNewtonCotes(const unsigned int d,
...
inline
QAnisotropicNewtonCotes::~QAnisotropicNewtonCotes()
{
}
