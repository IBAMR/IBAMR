...
// ------------------------------------------------------------
// QNewtonCotes class definition

class QNewtonCotes : public QBase
{
 public:
   ...
   */
  QNewtonCotes (const unsigned int _dim,
...
inline
QNewtonCotes::QNewtonCotes(const unsigned int d,
