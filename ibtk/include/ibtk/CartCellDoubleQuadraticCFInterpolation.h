...
private:
     ...
     */
    void postprocessRefine_expensive(SAMRAI::hier::PatchNd& fine,
                                     const SAMRAI::hier::PatchNd& coarse,
                                     const SAMRAI::hier::IntVectorNd& ratio);

    void postprocessRefine_optimized(SAMRAI::hier::PatchNd& fine,
                                     const SAMRAI::hier::PatchNd& coarse,
                                     const SAMRAI::hier::IntVectorNd& ratio);
     ...
     */
    void computeNormalExtension_expensive(SAMRAI::hier::PatchNd& patch,
                                          const SAMRAI::hier::IntVectorNd& ratio,
                                          const SAMRAI::hier::IntVectorNd& ghost_width_to_fill);

    void computeNormalExtension_optimized(SAMRAI::hier::PatchNd& patch, const SAMRAI::hier::IntVectorNd& ratio);
