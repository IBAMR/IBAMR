...
#ifndef LIBMESH_ANISOTROPIC_QUADRATURE_GAUSS_H
#define LIBMESH_ANISOTROPIC_QUADRATURE_GAUSS_H
...
// ------------------------------------------------------------
// QAnisotropicGauss class definition

class QAnisotropicGauss : public QAnisotropicBase
{
 public:
   ...
   */
  QAnisotropicGauss (const unsigned int _dim,
...
inline
QAnisotropicGauss::QAnisotropicGauss(const unsigned int d,
...
inline
QAnisotropicGauss::~QAnisotropicGauss()
{
}
