...
template <class SolverType>
inline void
PETScLevelSolverEigenReferenceShellBackend::initializeTypedSubdomainSolver(const Eigen::MatrixXd& local_operator,
...
PETScLevelSolverEigenReferenceShellBackend::solveTypedSubdomainSystem(const Eigen::VectorXd& rhs,
