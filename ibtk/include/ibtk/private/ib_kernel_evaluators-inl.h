...
#ifndef included_IBTK_ib_kernel_evaluators_inl
#define included_IBTK_ib_kernel_evaluators_inl
...
IBKernelEvaluators::IB3::get_stencil_width()
{
    return 3;
}

inline constexpr std::size_t
IBKernelEvaluators::IB4::get_stencil_width()
{
    return 4;
}

inline constexpr std::size_t
IBKernelEvaluators::IB5::get_stencil_width()
{
    return 5;
}

inline constexpr std::size_t
IBKernelEvaluators::IB6::get_stencil_width()
{
    return 6;
}
