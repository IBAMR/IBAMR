...
public:
     ...
     */
    static Vec createPETScVector(SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> > samrai_vec,
    ...
    static void getSAMRAIVector(Vec petsc_vec,
                                SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> >* samrai_vec);

    /*!
     * Restore the SAMRAI vector object associated with the given PETSc vector object.
     */
    static void restoreSAMRAIVector(Vec petsc_vec,
                                    SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> >* samrai_vec);
     ...
     */
    static void getSAMRAIVectorRead(Vec petsc_vec,
                                    SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> >* samrai_vec);

    /*!
     * Restore the SAMRAI vector object associated with the given PETSc vector object.
     */
    static void restoreSAMRAIVectorRead(Vec petsc_vec,
                                        SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> >* samrai_vec);
...
protected:
     ...
     */
    PETScSAMRAIVectorReal(SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> > samrai_vector,
...
private:
     ...
     */
    SAMRAIPointer<SAMRAI::solv::SAMRAIVectorRealNd<PetscScalar> > d_samrai_vector;
