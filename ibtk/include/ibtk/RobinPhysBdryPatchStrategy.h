 ...
 */
class RobinPhysBdryPatchStrategy : public SAMRAIRefinePatchStrategy
{
public:
    /*!
     ...
     */
    void setPhysicalBcCoef(SAMRAIRobinBcCoefStrategy* bc_coef);
     ...
     */
    virtual void accumulateFromPhysicalBoundaryData(SAMRAIPatch& patch,
                                                    double fill_time,
