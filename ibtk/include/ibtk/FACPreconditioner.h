...
protected:
    void FACVCycleNoPreSmoothing(SAMRAISAMRAIVectorReal<double>& u, SAMRAISAMRAIVectorReal<double>& f, int level_num);

    void muCycle(SAMRAISAMRAIVectorReal<double>& u,
                 SAMRAISAMRAIVectorReal<double>& f,
                 SAMRAISAMRAIVectorReal<double>& r,
                 int level_num,
                 int mu);

    void FCycle(SAMRAISAMRAIVectorReal<double>& u,
                SAMRAISAMRAIVectorReal<double>& f,
                SAMRAISAMRAIVectorReal<double>& r,
                int level_num);

    void FMGCycle(SAMRAISAMRAIVectorReal<double>& u,
                  SAMRAISAMRAIVectorReal<double>& f,
                  SAMRAISAMRAIVectorReal<double>& r,
                  int level_num,
                  int mu);
