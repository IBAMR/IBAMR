 ...
 * input filename provided on the command line, and finally relative to
 * source_dir when it is provided. If a matching file is found, then it is
 * inserted into the active PETSc options database.
 *
