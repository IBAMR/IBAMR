...
#ifndef included_IBTK_VCCCViscousDilatationalPETScLevelSolver
#define included_IBTK_VCCCViscousDilatationalPETScLevelSolver
...
{
/*!
 * \brief Class VCCCViscousDilatationalPETScLevelSolver is a subclass of CCPoissonPETScLevelSolver
 ...
 * and \f$\vec{u}\f$ and \f$\vec{f}\f$ are cell-centered quantities. The discretization
 ...
 * VCCCViscousDilatationalPETScLevelSolver:
 *
 * -# Create a VCCCViscousDilatationalPETScLevelSolver object.
 * -# Set the problem specification via setProblemSpecification(),
 *    setPhysicalBcCoef(), and setHomogeneousBc().
 * -# Initialize VCCCViscousDilatationalPETScLevelSolver object using the function
 ...
 */
class VCCCViscousDilatationalPETScLevelSolver : public CCPoissonPETScLevelSolver
{
public:
    /*!
     * \brief Constructor.
     */
    VCCCViscousDilatationalPETScLevelSolver(std::string object_name,
    ...
    /*!
     * \brief Static function to construct a VCCCViscousDilatationalPETScLevelSolver.
     */
    static SAMRAI::tbox::Pointer<PoissonSolver> allocate_solver(const std::string& object_name,
                                                                SAMRAI::tbox::Pointer<SAMRAI::tbox::Database> input_db,
                                                                const std::string& default_options_prefix)
    {
        return new VCCCViscousDilatationalPETScLevelSolver(object_name, input_db, default_options_prefix);
    } // allocate_solver
...
private:
     ...
     */
    VCCCViscousDilatationalPETScLevelSolver() = delete;
     ...
     */
    VCCCViscousDilatationalPETScLevelSolver(const VCCCViscousDilatationalPETScLevelSolver& from) = delete;
     ...
     */
    VCCCViscousDilatationalPETScLevelSolver& operator=(const VCCCViscousDilatationalPETScLevelSolver& that) = delete;
...
#endif // #ifndef included_IBTK_VCCCViscousDilatationalPETScLevelSolver
