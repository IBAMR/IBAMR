...
private:
    ...
    SAMRAIPointer<SAMRAICoarsenOperator> d_of_coarsen_op;
    SAMRAIPointer<SAMRAICoarsenOperator> d_on_s_coarsen_op;
    SAMRAIPointer<SAMRAICoarsenOperator> d_on_v_coarsen_op;
    SAMRAIPointer<SAMRAICoarsenOperator> d_os_coarsen_op;
    SAMRAIPointer<SAMRAICoarsenOperator> d_oe_coarsen_op;
    SAMRAIPointer<SAMRAICoarsenAlgorithm> d_of_coarsen_alg;
    SAMRAIPointer<SAMRAICoarsenAlgorithm> d_on_s_coarsen_alg;
