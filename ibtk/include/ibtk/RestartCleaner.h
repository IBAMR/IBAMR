...
public:
    /*!
     * \brief Utility Constructor with explicit parameters for testing or simple use cases.
     *
     * This constructor creates a RestartCleaner with direct parameter specification.
     * It is always enabled and uses the provided parameters directly.
     *
     ...
     *
     * This constructor integrates with IBAMR's standard configuration system.
     * The cleaner can be enabled or disabled through the configuration.
     * The input database is searched for the following keys:
     * - 'enable_cleaner' : Boolean to enable/disable the cleaner (default: false)
     * - 'keep_recent_files' : Integer number of files to keep (default: 5)
     ...
     *
     * For Database constructor: returns the value of 'enable_cleaner' parameter.
     * For explicit parameter constructor: always returns true.
     *
...
private:
    ...
    // Common members for both constructors
