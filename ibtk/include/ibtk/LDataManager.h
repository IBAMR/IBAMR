 ...
 * ordering as well as the data storage for forces and objects assosciated with the point. From each LNode object, we
 * can retrieve the Lagrangian index as well as any associated node data. The LNode objects for each processor are
 * contained in an LMesh object. The LMesh object contains two vector of LNodes: one containing just the local LNode
 * objects, and another containing 'ghost' LNodes. The 'ghost' LNodes are Lagrangian points located on other processors
