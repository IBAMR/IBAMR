...
{
/*!
 * \brief Class CartCellDoubleLinearRefine is a concrete
 * SAMRAI::xfer::RefineOperator object which prolongs cell-centered double
 * precision patch data via linear interpolation.
 */
...
#endif // #ifndef included_IBTK_CartCellDoubleLinearRefine
