...
private:
    ...
    std::array<SAMRAIPointer<SAMRAI::xfer::RefineAlgorithmNd>, NDIM> d_refine_alg;
    std::array<std::vector<SAMRAIPointer<SAMRAI::xfer::RefineScheduleNd> >, NDIM> d_refine_scheds;
};
} // namespace IBTK
