...
c
      do i2=ilower2,iupper2
         ...
         linear_stencil(i_c2,xi2,clower2,cupper2,clower2,cupper2,touches_regular_bdry(4),touches_regular_bdry(5),2)dnl

         do i1=ilower1,iupper1
            coarsen_index(i1,i_c1,i_f1,ratio(1))
            xi1 = (dble(i1-i_f1)+0.5d0)/dble(ratio(1)) - 0.5d0
            linear_stencil(i_c1,xi1,clower1,cupper1,clower1,cupper1,touches_regular_bdry(2),touches_regular_bdry(3),1)dnl

            do i0=ilower0,iupper0
               coarsen_index(i0,i_c0,i_f0,ratio(0))
               xi0 = (dble(i0-i_f0)+0.5d0)/dble(ratio(0)) - 0.5d0
               linear_stencil(i_c0,xi0,clower0,cupper0,clower0,cupper0,touches_regular_bdry(0),touches_regular_bdry(1),0)dnl
