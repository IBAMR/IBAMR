...
c
      do i2=ilower2,iupper2
         ...
         if (clower2 .eq. cupper2 .and.
     &       touches_regular_bdry(4) .ne. 0 .and.
     &       touches_regular_bdry(5) .ne. 0) then
            idx2(0) = i_c2
            idx2(1) = i_c2
            w2(0) = 1.d0
            w2(1) = 0.d0
     ...
     &            i_c2 .eq. cupper2 .and. xi2 .ge. 0.d0) then
         ...
         do i1=ilower1,iupper1
            ...
            if (clower1 .eq. cupper1 .and.
     &       touches_regular_bdry(2) .ne. 0 .and.
     &       touches_regular_bdry(3) .ne. 0) then
               idx1(0) = i_c1
               idx1(1) = i_c1
               w1(0) = 1.d0
               w1(1) = 0.d0
     ...
     &               i_c1 .eq. cupper1 .and. xi1 .ge. 0.d0) then
            ...
            do i0=ilower0,iupper0
               ...
               if (clower0 .eq. cupper0 .and.
     &       touches_regular_bdry(0) .ne. 0 .and.
     &       touches_regular_bdry(1) .ne. 0) then
                  idx0(0) = i_c0
                  idx0(1) = i_c0
                  w0(0) = 1.d0
                  w0(1) = 0.d0
