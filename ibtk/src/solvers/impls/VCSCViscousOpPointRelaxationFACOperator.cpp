...
// FORTRAN ROUTINES
#if (NDIM == 2)
#define VC_GS_SMOOTH_FC IBTK_FC_FUNC(f64_vcgssmooth2d, F64_VCGSSMOOTH2D)
#define VC_GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_vcgssmoothmask2d, F64_VCGSSMOOTHMASK2D)
#define VC_RB_GS_SMOOTH_FC IBTK_FC_FUNC(f64_vcrbgssmooth2d, F64_VCRBGSSMOOTH2D)
#define VC_RB_GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_vcrbgssmoothmask2d, F64_VCRBGSSMOOTHMASK2D)
#endif
#if (NDIM == 3)
#define VC_GS_SMOOTH_FC IBTK_FC_FUNC(f64_vcgssmooth3d, F64_VCGSSMOOTH3D)
#define VC_GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_vcgssmoothmask3d, F64_VCGSSMOOTHMASK3D)
#define VC_RB_GS_SMOOTH_FC IBTK_FC_FUNC(f64_vcrbgssmooth3d, F64_VCRBGSSMOOTH3D)
#define VC_RB_GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_vcrbgssmoothmask3d, F64_VCRBGSSMOOTHMASK3D)
#endif
