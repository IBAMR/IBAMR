...
void
VCSCViscousOpPointRelaxationFACOperator::smoothError(SAMRAISAMRAIVectorReal<double>& error,
...
void
VCSCViscousOpPointRelaxationFACOperator::computeResidual(SAMRAISAMRAIVectorReal<double>& residual,
...
void
VCSCViscousOpPointRelaxationFACOperator::restrictResidual(const SAMRAISAMRAIVectorReal<double>& src,
