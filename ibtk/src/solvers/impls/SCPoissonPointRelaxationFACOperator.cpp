...
#define GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_gssmoothmask2d, F64_GSSMOOTHMASK2D)
#define RB_GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_rbgssmoothmask2d, F64_RBGSSMOOTHMASK2D)
#endif
#if (NDIM == 3)
...
#define GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_gssmoothmask3d, F64_GSSMOOTHMASK3D)
#define RB_GS_SMOOTH_MASK_FC IBTK_FC_FUNC(f64_rbgssmoothmask3d, F64_RBGSSMOOTHMASK3D)
#endif
