...
bool
PETScNewtonKrylovSolver::solveSystem(SAMRAISAMRAIVectorReal<double>& x, SAMRAISAMRAIVectorReal<double>& b)
{
...
void
PETScNewtonKrylovSolver::initializeSolverState(const SAMRAISAMRAIVectorReal<double>& x,
...
PETScNewtonKrylovSolver::common_ctor()
{
    ...
    // Setup Timers.
    IBTK_DO_ONCE(
        t_solve_system = SAMRAITimerManager::getManager()->getTimer("IBTK::PETScNewtonKrylovSolver::solveSystem()");
        t_initialize_solver_state =
            SAMRAITimerManager::getManager()->getTimer("IBTK::PETScNewtonKrylovSolver::initializeOperatorState()");
        t_deallocate_solver_state =
            SAMRAITimerManager::getManager()->getTimer("IBTK::PETScNewtonKrylovSolver::deallocateOperatorState()"););
}
