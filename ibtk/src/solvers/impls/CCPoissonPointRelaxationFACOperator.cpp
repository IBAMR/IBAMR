...
void
CCPoissonPointRelaxationFACOperator::smoothError(SAMRAIVectorRealNd<double>& error,
...
bool
CCPoissonPointRelaxationFACOperator::solveCoarsestLevel(SAMRAIVectorRealNd<double>& error,
                                                        const SAMRAIVectorRealNd<double>& residual,
                                                        int coarsest_ln)
{
...
void
CCPoissonPointRelaxationFACOperator::computeResidual(SAMRAIVectorRealNd<double>& residual,
...
void
CCPoissonPointRelaxationFACOperator::initializeOperatorStateSpecialized(const SAMRAIVectorRealNd<double>& solution,
                                                                        const SAMRAIVectorRealNd<double>& rhs,
