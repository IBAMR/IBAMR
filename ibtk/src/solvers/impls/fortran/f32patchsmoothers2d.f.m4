...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_const_dc_2d(
     &     U,U_gcw,
     &     D,C,
     &     F,F_gcw,
     &     ilower0,iupper0,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_rb_const_dc_2d(
     &     U,U_gcw,
     &     D,C,
     &     F,F_gcw,
     &     ilower0,iupper0,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_rbgssmoothmask2d(
     &     U,U_gcw,
     &     alpha,beta,
     &     F,F_gcw,
     &     mask,mask_gcw,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_const_d_var_c_2d(
     &     U,U_gcw,
     &     D,
     &     C,C_gcw,
     &     F,F_gcw,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_rb_const_d_var_c_2d(
     &     U,U_gcw,
     &     D,
     &     C, C_gcw,
     &     F,F_gcw,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_var_d_const_c_2d(
     &     U,U_gcw,
     &     D0,D1,D_gcw,
     &     C,
     &     F,F_gcw,
...
c
      ...
      do i1 = ilower1,iupper1
         do i0 = ilower0,iupper0
            ...
            fac   = 1.0/(facu0+facl0+facu1+facl1-C)
            U(i0,i1) = fac*(
     &           facu0*U(i0+1,i1) +
     &           facl0*U(i0-1,i1) +
     &           facu1*U(i0,i1+1) +
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_rb_var_d_const_c_2d(
     &     U,U_gcw,
     &     D0,D1,D_gcw,
     &     C,
     &     F,F_gcw,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_var_dc_2d(
     &     U,U_gcw,
     &     D0,D1,D_gcw,
     &     C,C_gcw,
     &     F,F_gcw,
...
c
      ...
      do i1 = ilower1,iupper1
         do i0 = ilower0,iupper0
            ...
            facu1 = D1(i0,i1+1)/(hy*hy)
            facl1 = D1(i0,i1)/(hy*hy)
            fac   = 1.0/(facu0+facl0+facu1+facl1-C(i0,i1))
            U(i0,i1) = fac*(
     &           facu0*U(i0+1,i1) +
     &           facl0*U(i0-1,i1) +
     &           facu1*U(i0,i1+1) +
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_smooth_gs_rb_var_dc_2d(
     &     U,U_gcw,
     &     D0,D1,D_gcw,
     &     C,C_gcw,
     &     F,F_gcw,
...
c
     ...
     &       fac1**2.0*(mu(i0,i1+1) + mu(i0,i1))) - c

         nmr = -f0(i0,i1) + alpha*(fac*(
     &     mu_upper*u0(i0+1,i1) + mu_lower*u0(i0-1,i1))+
     &     fac1**2.0*(mu(i0,i1+1)*u0(i0,i1+1) + mu(i0,i1)*u0(i0,i1-1))+
     ...
     &                       mu(i0,i1-1),mu(i0+1,i1-1))
         ...
         dnr = alpha*(fac*(mu_upper+ mu_lower)+
     &      fac0**2.0*(mu(i0+1,i1) + mu(i0,i1))) - c

         nmr = -f1(i0,i1) + alpha*(fac*(
     &    mu_upper*u1(i0,i1+1) + mu_lower*u1(i0,i1-1))+
     &    fac0**2.0*(mu(i0+1,i1)*u1(i0+1,i1) + mu(i0,i1)*u1(i0-1,i1))+
...
c
     ...
     &         fac1**2.0*(mu(i0,i1+1) + mu(i0,i1))) - c
            ...
            nmr = -f0(i0,i1) + alpha*(fac*(
     &         mu_upper*u0(i0+1,i1) + mu_lower*u0(i0-1,i1))+
     &         fac1**2.0*(mu(i0,i1+1)*u0(i0,i1+1)+
     &            mu(i0,i1)*u0(i0,i1-1))+
     ...
     &         fac0**2.0*(mu(i0+1,i1) + mu(i0,i1))) - c
            ...
            nmr = -f1(i0,i1) + alpha*(fac*(
     &         mu_upper*u1(i0,i1+1) + mu_lower*u1(i0,i1-1))+
     &         fac0**2.0*(mu(i0+1,i1)*u1(i0+1,i1)+
     &            mu(i0,i1)*u1(i0-1,i1))+
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_vcgssmoothmask2d(
     &     u0,u1,u_gcw,
     &     f0,f1,f_gcw,
...
ccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccccc
c
      subroutine f32_vcrbgssmoothmask2d(
     &     u0,u1,u_gcw,
     &     f0,f1,f_gcw,
     &     mask0,mask1,mask_gcw,
     &     c0,c1,c_gcw,
