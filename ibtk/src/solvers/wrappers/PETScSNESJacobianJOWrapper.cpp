...
void
PETScSNESJacobianJOWrapper::apply(SAMRAIVectorRealNd<double>& x, SAMRAIVectorRealNd<double>& y)
{
...
void
PETScSNESJacobianJOWrapper::applyAdd(SAMRAIVectorRealNd<double>& x,
                                     SAMRAIVectorRealNd<double>& y,
                                     SAMRAIVectorRealNd<double>& z)
{
    if (!d_is_initialized) initializeOperatorState(x, y);
...
void
PETScSNESJacobianJOWrapper::initializeOperatorState(const SAMRAIVectorRealNd<double>& in,
