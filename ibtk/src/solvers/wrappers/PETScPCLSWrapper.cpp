...
bool
PETScPCLSWrapper::solveSystem(SAMRAISAMRAIVectorReal<double>& x, SAMRAISAMRAIVectorReal<double>& b)
{
...
void
PETScPCLSWrapper::initializeSolverState(const SAMRAISAMRAIVectorReal<double>& x,
