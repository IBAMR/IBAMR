...
PETScSAMRAIVectorReal::PETScSAMRAIVectorReal(SAMRAIPointer<SAMRAIVectorRealNd<PetscScalar> > samrai_vector,
...
PETScSAMRAIVectorReal::VecDuplicate_SAMRAI(Vec v, Vec* newv)
{
    ...
    PSVR_CHECK1(v);
    PetscErrorCode ierr;
    SAMRAIPointer<SAMRAIVectorRealNd<PetscScalar> > samrai_vec = PSVR_CAST2(v)->cloneVector(PSVR_CAST2(v)->getName());
