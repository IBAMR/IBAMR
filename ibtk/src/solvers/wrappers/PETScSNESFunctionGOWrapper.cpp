...
void
PETScSNESFunctionGOWrapper::apply(SAMRAIVectorRealNd<double>& x, SAMRAIVectorRealNd<double>& y)
{
...
void
PETScSNESFunctionGOWrapper::initializeOperatorState(const SAMRAIVectorRealNd<double>& in,
