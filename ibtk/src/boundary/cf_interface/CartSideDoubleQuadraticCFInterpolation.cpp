...
void
CartSideDoubleQuadraticCFInterpolation::setPhysicalBoundaryConditions(PatchNd& /*patch*/,
...
void
CartSideDoubleQuadraticCFInterpolation::preprocessRefine(PatchNd& /*fine*/,
...
void
CartSideDoubleQuadraticCFInterpolation::postprocessRefine(PatchNd& fine,
                                                          const PatchNd& coarse,
                                                          const BoxNd& fine_box,
                                                          const IntVectorNd& ratio)
{
...
CartSideDoubleQuadraticCFInterpolation::setPatchHierarchy(Pointer<PatchHierarchyNd> hierarchy)
{
    ...
    const IntVectorNd& max_ghost_width = GHOST_WIDTH_TO_FILL;
...
void
CartSideDoubleQuadraticCFInterpolation::computeNormalExtension(PatchNd& patch,
                                                               const IntVectorNd& ratio,
                                                               const IntVectorNd& /*ghost_width_to_fill*/)
{
#if !defined(NDEBUG)
