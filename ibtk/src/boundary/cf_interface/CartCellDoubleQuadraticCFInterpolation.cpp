                                                          ...
                                                          const SAMRAIIntVector& ratio)
{
    ...
    else
    {
        ...
        SAMRAIPointer<SAMRAIPatchLevel> fine_level = d_hierarchy->getPatchLevel(fine_patch_level_num);
...
void
CartCellDoubleQuadraticCFInterpolation::setPatchHierarchy(SAMRAIPointer<SAMRAIPatchHierarchy> hierarchy)
{
#if !defined(NDEBUG)
                                                                    ...
                                                                    const SAMRAIIntVector& ratio)
{
    ...
    for (int patch_data_index : d_patch_data_indices)
    {
        ...
        SAMRAIPointer<SAMRAICartesianPatchGeometry> pgeom_fine = fine.getPatchGeometry();
        ...
        SAMRAIPointer<SAMRAICartesianPatchGeometry> pgeom_crse = coarse.getPatchGeometry();
