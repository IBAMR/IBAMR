...
get_characteristics(Pointer<SAMRAIPatchDescriptor> patch_descriptor, const int idx)
{
...
void
SAMRAIDataCache::setPatchHierarchy(Pointer<SAMRAIPatchHierarchy> hierarchy)
{
