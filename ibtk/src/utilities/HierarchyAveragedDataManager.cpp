...
void
HierarchyAveragedDataManager::commonConstructor(SAMRAIPointer<Database> input_db)
{
                                                         ...
                                                         const double tol)
{
    ...
    if (d_output_data)
    {
        ...
        SAMRAIPointer<HierarchyGhostCellInterpolation> ghost_fill = new HierarchyGhostCellInterpolation();
...
void
HierarchyAveragedDataManager::putToDatabase(SAMRAIPointer<Database> db)
{
