...
if test "${LIBMESH_COMPILE_MODE}" == "opt" ; then
  CPPFLAGS="${CPPFLAGS} `grep -A3 opt-mode $LIBMESH_DIR/Make.common | grep libmesh_CPPFLAGS | sed -e 's/.*libmesh_CPPFLAGS +=//'`"
  CXXFLAGS="${CXXFLAGS} `grep -A3 opt-mode $LIBMESH_DIR/Make.common | grep libmesh_CXXFLAGS | sed -e 's/.*libmesh_CXXFLAGS +=//'`"
  CFLAGS="${CFLAGS} `grep -A3 opt-mode $LIBMESH_DIR/Make.common | grep libmesh_CFLAGS | sed -e 's/.*libmesh_CFLAGS   +=//'`"
fi
if test "${LIBMESH_COMPILE_MODE}" == "devel" ; then
  CPPFLAGS="${CPPFLAGS} `grep -A3 devel-mode $LIBMESH_DIR/Make.common | grep libmesh_CPPFLAGS | sed -e 's/.*libmesh_CPPFLAGS +=//'`"
  CXXFLAGS="${CXXFLAGS} `grep -A3 devel-mode $LIBMESH_DIR/Make.common | grep libmesh_CXXFLAGS | sed -e 's/.*libmesh_CXXFLAGS +=//'`"
  CFLAGS="${CFLAGS} `grep -A3 devel-mode $LIBMESH_DIR/Make.common | grep libmesh_CFLAGS | sed -e 's/.*libmesh_CFLAGS   +=//'`"
fi
if test "${LIBMESH_COMPILE_MODE}" == "dbg" ; then
  CPPFLAGS="${CPPFLAGS} `grep -A3 debug-mode $LIBMESH_DIR/Make.common | grep libmesh_CPPFLAGS | sed -e 's/.*libmesh_CPPFLAGS +=//'`"
  CXXFLAGS="${CXXFLAGS} `grep -A3 debug-mode $LIBMESH_DIR/Make.common | grep libmesh_CXXFLAGS | sed -e 's/.*libmesh_CXXFLAGS +=//'`"
  CFLAGS="${CFLAGS} `grep -A3 debug-mode $LIBMESH_DIR/Make.common | grep libmesh_CFLAGS | sed -e 's/.*libmesh_CFLAGS   +=//'`"
fi
if test "${LIBMESH_COMPILE_MODE}" == "prof" ; then
  CPPFLAGS="${CPPFLAGS} `grep -A3 prof-mode $LIBMESH_DIR/Make.common | grep libmesh_CPPFLAGS | sed -e 's/.*libmesh_CPPFLAGS +=//'`"
  CXXFLAGS="${CXXFLAGS} `grep -A3 prof-mode $LIBMESH_DIR/Make.common | grep libmesh_CXXFLAGS | sed -e 's/.*libmesh_CXXFLAGS +=//'`"
  CFLAGS="${CFLAGS} `grep -A3 prof-mode $LIBMESH_DIR/Make.common | grep libmesh_CFLAGS | sed -e 's/.*libmesh_CFLAGS   +=//'`"
fi
if test "${LIBMESH_COMPILE_MODE}" == "oprof" ; then
  CPPFLAGS="${CPPFLAGS} `grep -A3 oprof-mode $LIBMESH_DIR/Make.common | grep libmesh_CPPFLAGS | sed -e 's/.*libmesh_CPPFLAGS +=//'`"
  CXXFLAGS="${CXXFLAGS} `grep -A3 oprof-mode $LIBMESH_DIR/Make.common | grep libmesh_CXXFLAGS | sed -e 's/.*libmesh_CXXFLAGS +=//'`"
  CFLAGS="${CFLAGS} `grep -A3 oprof-mode $LIBMESH_DIR/Make.common | grep libmesh_CFLAGS | sed -e 's/.*libmesh_CFLAGS   +=//'`"
fi
