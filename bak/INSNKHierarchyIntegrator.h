#ifndef included_INSNKHierarchyIntegrator
...
{
/*!
 * \brief Class INSNKHierarchyIntegrator manages the spatial discretization and
 * time integration of the incompressible Navier-Stokes equations.
 */
class INSNKHierarchyIntegrator
    : public SAMRAI::mesh::StandardTagAndInitStrategy<NDIM>,
      public SAMRAI::tbox::Serializable
{
public:
    /*!
     * The constructor for INSNKHierarchyIntegrator sets some default values,
    ...
    /*!
     * The destructor for INSNKHierarchyIntegrator unregisters the integrator
    ...
    ///
    ///  allow the INSNKHierarchyIntegrator to be used as a hierarchy
    ///  integrator.
    ///
    ...
    ///
    ///  allow the INSNKHierarchyIntegrator to provide data management for a
...
private:
     ...
     */
    INSNKHierarchyIntegrator(
        const INSNKHierarchyIntegrator& from);
...
//#include <ibamr/INSNKHierarchyIntegrator.I>
