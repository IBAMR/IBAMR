...
// Last modified: <13.Aug.2007 16:33:17 griffith@box221.cims.nyu.edu>
...
public:
     ...
     *
     * Optional concrete STOOLS::SetDataStrategy and PhysicalBCDataStrategy
...
private:
    ...
    SAMRAI::tbox::Pointer<STOOLS::SetDataStrategy> d_Q_set;
