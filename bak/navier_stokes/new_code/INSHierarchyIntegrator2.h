#ifndef included_INSHierarchyIntegrator2
#define included_INSHierarchyIntegrator2

// Filename: INSHierarchyIntegrator2.h
// Last modified: <10.Jul.2007 02:24:58 boyce@bigboy.nyconnect.com>
...
{
/*!
 * \brief Class INSHierarchyIntegrator2 manages the spatial discretization and
 ...
 */
class INSHierarchyIntegrator2
    : public SAMRAI::mesh::StandardTagAndInitStrategy<NDIM>,
      public SAMRAI::tbox::Serializable
{
public:
    /*!
     * The constructor for INSHierarchyIntegrator2 sets some default values,
    ...
    /*!
     * The destructor for INSHierarchyIntegrator2 unregisters the integrator
     ...
     */
    void
    registerPressurePhysicalBcCoefs(
        const SAMRAI::solv::RobinBcCoefStrategy<NDIM>* P_bc_coefs);
...
private:
     ...
     */
    INSHierarchyIntegrator2(
        const INSHierarchyIntegrator2& from);
    ...
    INSHierarchyIntegrator2&
    operator=(
        const INSHierarchyIntegrator2& that);
     ...
     * pressure and body force for plotting.
     */
    SAMRAI::tbox::Pointer<SAMRAI::appu::VisItDataWriter<NDIM> > d_visit_writer;
    double d_P_scale, d_F_scale;
    ...
    /*
     * These boolean values indicate whether to output the pressure or applied
     * body force for visualization.
     */
    bool d_output_P;
    bool d_output_F;
     ...
     */
    SAMRAI::tbox::Pointer<SAMRAI::pdat::CellVariable<NDIM,double> > d_U_var, d_U_tilde_var, d_F_var;
    ...
    SAMRAI::tbox::Pointer<SAMRAI::pdat::FaceVariable<NDIM,double> > d_u_var, d_u_tilde_var, d_u_adv_var;
    ...
    int d_u_tilde_current_idx, d_u_tilde_new_idx, d_u_tilde_scratch_idx;
    ...
    /*
     * Patch data descriptors for all state variables managed by the
    ...
    SAMRAI::tbox::Pointer<STOOLS::CCLaplaceOperator>           d_helmholtz4_op    ;
    SAMRAI::tbox::Pointer<SAMRAI::solv::PoissonSpecifications> d_helmholtz4_spec  ;
    SAMRAI::tbox::Pointer<STOOLS::KrylovLinearSolver>          d_helmholtz4_solver;
    bool d_helmholtz_solver_need_init;
};
}// namespace IBAMR

/////////////////////////////// INLINE ///////////////////////////////////////

//#include <ibamr/INSHierarchyIntegrator2.I>
